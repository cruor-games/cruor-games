...
export const WORKFLOWS = {
  ...
  encounter: {
    ...
    description:
      "Add corruption, phases, lair pressure, and death effects to a fight you already planned.",
  ...
  reward: {
    ...
    description:
      "Turn loot, boons, secrets, mutations, or relics into useful rewards with a disturbing cost.",
  ...
  clue: {
    ...
    description:
      "Attach a disturbing reveal, false reading, check, and follow-up complication to an existing clue.",
...
export const SLOT_DESCRIPTIONS = {
  ...
  mechanicalCheck:
    "the check, save, DC, or rule interaction attached to the clue.",
