...
const MONSTER_TIERS = [
  { id: "normal", label: "Normal", summary: "Baseline monster for its CR.", hpMult: 1, dprMult: 1, acMod: 0, budgetOffset: 0, complexityCapOffset: 0, pressureMod: 0 },
  { id: "elite", label: "Elite", summary: "Stronger single threat without full legendary action economy.", hpMult: 1.32, dprMult: 1.12, acMod: 0, budgetOffset: 3, complexityCapOffset: 2, pressureMod: 2 },
  { id: "boss", label: "Boss", summary: "Setpiece creature with phases, reactions, or lair pressure.", hpMult: 1.75, dprMult: 1.22, acMod: 1, budgetOffset: 6, complexityCapOffset: 4, pressureMod: 4 },
  { id: "legendary", label: "Legendary", summary: "Solo-grade monster with alternative action economy.", hpMult: 1.95, dprMult: 1.35, acMod: 1, budgetOffset: 8, complexityCapOffset: 5, pressureMod: 6 },
  { id: "setpiece", label: "Setpiece", summary: "Encounter-defining horror object, ritual beast, or scene monster.", hpMult: 1.55, dprMult: 1.05, acMod: 0, budgetOffset: 7, complexityCapOffset: 6, pressureMod: 5 },
];

const TEMPO_PROFILES = [
  { id: "slow", label: "Slow", summary: "Predictable, heavy, and easier to kite.", initiativeMod: -2, dprMult: 0.9, attackMod: 0, budgetMod: -1, complexityMod: 0, pressureMod: -1 },
  { id: "standard", label: "Standard", summary: "Uses ordinary initiative and turn rhythm.", initiativeMod: 0, dprMult: 1, attackMod: 0, budgetMod: 0, complexityMod: 0, pressureMod: 0 },
  { id: "fast", label: "Fast", summary: "Acts early and can punish exposed characters.", initiativeMod: 2, dprMult: 1.06, attackMod: 0, budgetMod: 1, complexityMod: 1, pressureMod: 1 },
  { id: "ambusher", label: "Ambusher", summary: "Front-loaded pressure before the party fully stabilizes.", initiativeMod: 3, dprMult: 1.12, attackMod: 1, budgetMod: 2, complexityMod: 1, pressureMod: 2 },
  { id: "legendary", label: "Legendary", summary: "Boss tempo through initiative, reactions, lair pressure, or off-turn actions.", initiativeMod: 4, dprMult: 1.18, attackMod: 1, budgetMod: 3, complexityMod: 2, pressureMod: 3 },
];
...
const MONSTER_FAMILY_PRESETS = [
  ...
  },
  {
    ...
    tempoProfileId: "slow",
    dangerId: "horror",
    summary: "An immobile pressure bomb built around toxic rupture, scene control, and telegraphed danger.",
    selection: {
  ...
  },
  {
    ...
    dangerId: "hard",
    summary: "A corpse-feeding spirit with shame, incorporeal movement, bite pressure, and ritual counterplay.",
    selection: {
      body: "ethereal-sight",
      mind: "corpse-craving",
  ...
  },
  {
    ...
    tempoProfileId: "fast",
    dangerId: "horror",
    summary: "A higher-pressure Jikininki variant focused on infection, corpse anchors, and delayed harm.",
    selection: {
      body: "ethereal-sight",
      mind: "shame-hunger",
  ...
  },
  {
    ...
    tempoProfileId: "fast",
    dangerId: "hard",
    summary: "A web-and-egg setpiece using visible brood pressure, restrained targets, and fire counterplay.",
    selection: {
      body: "egg-carrier",
  ...
  },
  {
    ...
    tempoProfileId: "ambusher",
    dangerId: "hard",
    summary: "A stealth predator built around darkness, sudden movement, venom, and light-based counterplay.",
    selection: {
      body: "umbral-skin",
      mind: "hunter-spider",
  ...
  },
  {
    ...
    dangerId: "hard",
    summary: "A skeletal pressure monster focused on reassembly, dragging movement, and ossuary scene control.",
    selection: {
  ...
  },
  {
    ...
    tempoProfileId: "fast",
    dangerId: "hard",
    summary: "A gothic stalker with a readable mask weakness, unwatched movement, and identity horror.",
    selection: {
...
const SLOTS = [
  ...
  { id: "lair", label: "Lair / Scene Effect", icon: BookOpen, hint: "Optional pressure from the environment." },
];
...
const MONSTER_SILHOUETTES = {
  ...
  beast: {
    ...
    layers: [
      { id: "aura", d: "M50 214 C66 131 126 91 196 111 C258 128 270 210 225 284 C181 357 74 330 50 214 Z" },
      { id: "body", d: "M68 205 C82 150 128 125 182 137 C226 147 244 186 231 229 C218 272 181 300 136 292 C91 284 56 252 68 205 Z" },
      { id: "head", d: "M175 123 C205 98 245 115 248 151 C250 179 230 199 202 197 C175 196 154 179 155 153 C155 141 162 131 175 123 Z" },
      { id: "legs", d: "M95 266 L69 337 L96 344 L121 276 Z M139 283 L128 357 L156 357 L166 283 Z M180 268 L207 337 L232 328 L202 258 Z" },
  ...
  aberration: {
    ...
    layers: [
      { id: "aura", d: "M151 38 C205 44 243 92 237 151 C283 186 262 258 215 270 C207 337 154 389 102 358 C54 330 55 260 87 229 C44 194 55 123 103 112 C107 70 124 45 151 38 Z" },
      { id: "body", d: "M148 101 C189 95 220 130 216 176 C253 204 232 260 188 257 C173 304 118 311 97 269 C61 263 46 213 77 187 C68 143 102 104 148 101 Z" },
      { id: "eye", d: "M150 136 C181 136 203 154 214 179 C200 206 180 221 150 221 C120 221 100 206 86 179 C97 154 119 136 150 136 Z M150 157 C137 157 127 167 127 180 C127 193 137 203 150 203 C163 203 173 193 173 180 C173 167 163 157 150 157 Z" },
      { id: "tendrils", d: "M96 247 C50 277 39 316 61 355 C70 322 89 300 125 282 Z M188 248 C239 279 249 319 225 358 C216 323 197 300 163 282 Z M135 275 C119 321 123 358 153 389 C149 350 157 319 174 282 Z" },
    ],
  },
};
...
const FEATURES = [
  // Decomposition / Bloated
  {
    ...
    mechanics: "When the creature is first bloodied, each creature within 5 feet makes a Constitution save. On a failure, the target has the Poisoned condition until the end of its next turn.",
  ...
  },
  {
    ...
    complexity: 1,
    stats: { ac: 2, hp: 18 },
    summary: "The cadaver has only recently entered the bloating stage and still moves with heavy resilience.",
    tags: ["bloated_body", "defensive_body"],
    mechanics: "The creature gains a +2 bonus to AC while it has more than half its hit points. When bloodied, reduce its AC by 2 and increase its walking speed by 10 feet.",
  ...
  },
  {
    ...
    mechanics: "The creature's speed becomes 0. It gains reach 10 ft. with body, bite, or grab attacks. Effects that push, pull, or drag it move it only half the normal distance.",
    counterplay: "Players can reposition around it, attack from range, or use forced movement to aim the eventual rupture.",
  },
  {
    id: "skin-slippage",
    title: "Skin Slippage",
    ...
    mechanics: "The creature has advantage on checks and saves made to escape a grapple. A creature that grapples it must succeed on a Constitution save or have disadvantage on the next attack roll it makes before the end of its turn.",
  ...
  },
  {
    ...
    mechanics: "At the start of combat, define one simple command. The creature prioritizes that command even when doing so is tactically poor. If no command applies, it attacks the nearest living creature.",
  ...
  },
  {
    ...
    mechanics: "When the creature starts its turn bloodied, it can move up to 10 feet toward the nearest enemy without provoking opportunity attacks, then it must attack that enemy if able.",
  ...
  },
  {
    ...
    mechanics: "The creature ignores nonmagical difficult terrain created by rubble, corpses, or mud, but it has disadvantage on Dexterity saving throws.",
  ...
  },
  {
    ...
    mechanics: "The creature is immune to the Prone condition while its speed is 10 feet or lower. If an effect would knock it prone, reduce its speed by 5 feet until the end of combat instead.",
    counterplay: "Players can slow it by targeting legs, but cannot simply disable it with prone loops.",
  },
  {
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes bludgeoning damage. If the creature moved at least 10 feet straight toward the target this turn, add one extra damage die.",
  ...
  },
  {
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes bludgeoning damage and must succeed on a Strength save or be pushed 5 feet. If the target collides with a creature or object, both take bludgeoning damage equal to the proficiency bonus.",
  ...
  },
  {
    ...
    mechanics: "One Large or smaller creature within reach makes a Dexterity save. On a failure, the target has the Grappled condition and is Restrained while the grapple lasts. The target can escape with an Athletics or Acrobatics check against the monster DC.",
  ...
  },
  {
    ...
    mechanics: "When the creature drops to 0 hit points, roll a d6. On a 4 or higher, trigger one selected Unstable reaction before the creature dies.",
    counterplay: "Radiant damage, careful positioning, or distance can reduce the danger of the final hit.",
  },
  {
    id: "unstable-rupture",
    ...
    mechanics: "Trigger: the creature takes piercing or slashing damage. Response: roll a d6. On a 6, the creature explodes or releases a toxic burst. Each creature within 10 feet makes a Dexterity save, taking poison damage on a failure or half as much on a success.",
  ...
  },
  {
    ...
    counterplay: "Its immobility, swelling, and audible pressure make the blast radius readable before combat.",
  },
  {
    id: "undead-fortitude",
    ...
    mechanics: "If damage reduces the creature to 0 hit points, it makes a Constitution save with a DC equal to 5 plus the damage taken, unless the damage is radiant, from a critical hit, or caused it to explode. On a success, it drops to 1 hit point instead.",
  ...
  },
  {
    ...
    mechanics: "A character can target the head with a called shot. The attack takes a -5 penalty. On a hit, the attack becomes a critical hit.",
  ...
  },
  {
    ...
    mechanics: "When the creature takes more than half its maximum hit points in one hit, the attacker chooses head, arms, or leg. Head: the creature is Blinded but dies in 2 rounds without triggering Gas Buildup. Arms: it has disadvantage on attacks requiring arms. Leg: it falls prone and its speed becomes 5 feet.",
  ...
  },
  {
    ...
    mechanics: "When the creature takes radiant damage, it cannot use Unstable reactions until the start of its next turn.",
  ...
  },
  {
    ...
    mechanics: "On death, the corpse creates a 10-foot patch of slick rot. The area is difficult terrain. A character who examines it can find one clue tied to the Source Anchor.",
  ...
  },
  {
    ...
    mechanics: "On death, each creature within 10 feet makes a Dexterity save. On a failure, the target takes poison damage and has the Poisoned condition until the end of its next turn. On a success, the target takes half damage only.",
  ...
  },
  {
    ...
    mechanics: "On death, a 15-foot area becomes slick and foul until cleaned or burned away. It is difficult terrain. A creature that enters it for the first time on a turn or starts there makes a Dexterity save or falls Prone.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, choose one 10-foot area. Until the next count 20, the area is lightly obscured, and creatures that start there make a Constitution save or cannot take reactions until their next turn.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, one corpse or body part in the lair swells. Until the next count 20, the first creature that moves within 5 feet of it triggers a small toxic burst requiring a Constitution save.",
  ...
  // Jikininki / Ravenous Spirit
  {
    ...
    mechanics: "It prioritizes creatures carrying holy symbols, funerary items, or fresh wounds. Once per fight, after it damages such a target, it regains hit points equal to the target's proficiency bonus + level tier.",
  ...
  },
  {
    ...
    mechanics: "If the creature can see an unattended corpse, it must succeed on a Wisdom save at the start of its turn or move toward the corpse and feed. While feeding, its attacks against creatures have disadvantage.",
    counterplay: "A prepared corpse, contaminated meal, or funerary decoy can redirect the monster.",
  },
  {
    ...
    mechanics: "During the day, the creature retreats to the Ethereal Plane or a hidden refuge if able. During the night, it gains advantage on Dexterity (Stealth) checks made near graveyards, temples, alleys, or corpse sites.",
    counterplay: "Daylight investigations and forced exposure weaken the encounter before combat begins.",
  },
  {
    id: "ethereal-sight",
    ...
    mechanics: "The creature can see 60 feet into the Ethereal Plane while it is on the Material Plane, and it has advantage on checks made to locate invisible or ethereal undead.",
    counterplay: "It is still limited by walls, line of sight, and mundane concealment on its current plane.",
  },
  {
    ...
    mechanics: "The creature can move through other creatures and objects as if they were difficult terrain. It takes force damage if it ends its turn inside an object.",
    counterplay: "Readied actions, force effects, and keeping it out of walls punish careless movement.",
  },
  {
    id: "grave-bite",
    title: "Grave Bite",
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes piercing damage plus necrotic damage. If the target is below half hit points, the monster gains temporary hit points equal to the necrotic damage dealt.",
  ...
  },
  {
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes poison or necrotic damage. If the target is not undead, it makes a Constitution save. On a failure, it gains 1 level of Exhaustion at the end of its next Long Rest, to a maximum of 3 levels from this feature.",
    counterplay: "Magic that cures disease, consecrated rest, or removing the curse before the next Long Rest stops the delayed harm.",
  },
  {
    id: "purulent-bite",
    title: "Purulent Bite",
    ...
    counterplay: "The delayed effect gives time for investigation, cleansing, or magical treatment.",
  },
  {
  ...
  },
  {
    ...
    mechanics: "Choose a corpse within 30 feet. Creatures in a 10-foot emanation from that corpse make a Dexterity save. On a failure, a target has the Restrained condition for 1 minute. It repeats the save at the end of each of its turns, ending the effect on a success.",
  ...
  },
  {
    ...
    mechanics: "The creature can consume a Medium or smaller corpse using an action. For each corpse consumed this way, it gains a +1 bonus to attack rolls, damage rolls, and AC until dawn, to a maximum bonus equal to its proficiency bonus.",
  ...
  },
  {
    ...
    complexity: 2,
    stats: { control: 2 },
    summary: "The spirit wears clothes, mannerisms, and fragments of identity stolen from the corpses it devoured.",
    mechanics: "The creature can appear as a mundane person whose corpse it has consumed. A creature can identify the deception with a successful Insight or Investigation check contested by the monster's Deception, or by magical means.",
    counterplay: "Suspicious details, funerary records, and body evidence can expose it without combat.",
  },
  {
    id: "mortal-afterlife",
    ...
    mechanics: "If publicly exposed by its community, the creature must succeed on a Wisdom save or spend its next turn fleeing toward its lair, refuge, or a corpse it can use to rebuild its identity.",
  ...
  },
  {
    ...
    mechanics: "3/day. The creature has the Invisible condition until its concentration ends. The effect ends early immediately after the creature makes an attack roll.",
  ...
  },
  {
    ...
    summary: "The spirit is most dangerous before the victims realize the dead thing is already among them.",
    mechanics: "During its first turn, the creature has advantage on attack rolls against any creature that has not taken a turn. Any hit it scores against a surprised creature is a critical hit.",
  ...
  },
  {
    ...
    mechanics: "Trigger: a hostile creature sees the spirit feeding on a corpse or repugnant meal. Response: the spirit becomes enraged for 1 minute. While enraged, it gains bonus damage on bite attacks and advantage on Intelligence checks and saves, but it must attack a witness each turn if able.",
  ...
  },
  {
    ...
    mechanics: "While forced to remain on the Material Plane during daytime, the creature has disadvantage on attack rolls, ability checks, and saving throws.",
    counterplay: "Ritual anchors, daylight pursuit, or binding circles can create a decisive advantage.",
  },
  {
    id: "shameful-feeding",
    ...
    mechanics: "If caught eating a corpse or other repugnant meal, the creature has the Frightened condition until it succeeds on a Wisdom save at the start of one of its turns. This overrides immunity to the Frightened condition.",
  ...
  },
  {
    ...
    mechanics: "A corpse soaked in holy water, packed with salt, or otherwise prepared against ghosts counts as bait. If the spirit feeds from it, it takes radiant damage and cannot use Incorporeal Movement until the end of its next turn.",
    counterplay: "The players can defeat or weaken the monster through preparation instead of raw damage.",
  },
  {
    id: "salt-and-names",
    ...
    complexity: 1,
    stats: { fairness: 2 },
    summary: "The creature recoils from burial rites, salt, and being named as the dead person it was.",
    mechanics: "A character who spends an action invoking a true name, funeral rite, or line of salt can force a Wisdom save. On a failure, the monster cannot willingly move closer to that character until the end of its next turn.",
  ...
  },
  {
    ...
    mechanics: "On death, the creature leaves spectral dust and small grave goods from its meals. A character who studies them learns one useful fact about the spirit's feeding route, victim, or lair.",
  ...
  },
  {
    ...
    mechanics: "On death, one creature within 30 feet hears a stolen memory. That creature makes a Wisdom save. On a failure, it is Frightened until the end of its next turn. Success or failure, it learns one clue from the consumed victim.",
    counterplay: "Covering the corpse's face or completing a funeral rite before the killing blow prevents the fear effect but preserves the clue.",
  },
  {
    ...
    mechanics: "At initiative count 20, choose a 20-foot area. Until the next count 20, sound in that area is muffled. Creatures inside have disadvantage on checks relying on hearing, and verbal spell components require a successful spellcasting ability check against the monster DC.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, one funerary object or corpse within 60 feet becomes a lure. Until the next count 20, a creature that starts within 10 feet of it makes a Wisdom save or must spend 10 feet of movement moving toward it.",
  ...
  // Wolf Spiders / Broodmother
  {
    ...
    summary: "It protects a brood carried on its body and becomes more violent when the young are threatened.",
    mechanics: "The first time it is bloodied, a brood swarm appears in an adjacent space. Until the brood is destroyed, the creature gains +2 damage on melee attacks.",
  ...
  },
  {
    ...
    mechanics: "The creature carries eggs on its back. At the start of each combatant's turn while eggs remain, roll a d20. On a 1, one egg breaks. On a 13-19, one egg hatches into a spider minion. On a 20, 1d4+1 eggs hatch. The eggs can be attacked and destroyed as fragile objects.",
  ...
  },
  {
    ...
    mechanics: "The creature can climb difficult surfaces, including upside down on ceilings, without needing to make an ability check.",
  ...
  },
  {
    ...
    mechanics: "The creature ignores movement restrictions caused by webs, and it knows the location of any other creature in contact with the same web.",
  ...
  },
  {
    ...
    mechanics: "At the start of each of its turns, the creature deals piercing damage to any creature grappling it or being grappled by it.",
  ...
  },
  {
    ...
    mechanics: "While in darkness, the creature has the Invisible condition. The condition ends immediately when the creature enters bright light or takes fire or radiant damage.",
  ...
  },
  {
    ...
    summary: "The offspring is fragile, wet, misshapen, and useful mainly as a horrible battlefield resource.",
    mechanics: "The creature has 1 hit point. A Broodmother or allied spider within 5 feet can use a bonus action to devour it and regain hit points equal to 2d6 plus proficiency bonus.",
  ...
  },
  {
    ...
    mechanics: "The creature cannot be surprised while conscious and gains a bonus to passive Perception equal to twice its proficiency bonus.",
  ...
  },
  {
    ...
    mechanics: "The creature gains a climb speed equal to its walking speed and ignores difficult terrain caused by webs, rubble, or bones.",
    counterplay: "Characters can force it down by breaking surfaces, burning webbing, or using thunderous effects.",
  },
  {
    id: "web-dancer",
    title: "Web Dancer",
    ...
    complexity: 2,
    stats: { mobility: 3 },
    summary: "It shoots a strand of web and swings across the lair without opening itself to retaliation.",
    mechanics: "The creature shoots a strand of web at a surface within 60 feet it can see. As part of this bonus action, it moves along the web up to its remaining speed without provoking opportunity attacks. The web can be attacked and destroyed as a fragile object vulnerable to fire.",
  ...
  },
  {
    ...
    mechanics: "3/day. The creature teleports up to 40 feet to an unoccupied space in darkness it can see.",
  ...
  },
  {
    ...
    mechanics: "The creature jumps up to 30 feet in any direction without provoking opportunity attacks. If it lands within 5 feet of an enemy, it has advantage on the next attack against that enemy before the end of the turn.",
  ...
  },
  {
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes piercing damage and makes a Constitution save. Failure: poison damage. If this damage reduces the target to 0 hit points, the target has the Paralyzed and Poisoned conditions for 1 hour. Success: half poison damage only.",
  ...
  },
  {
    ...
    mechanics: "Melee Attack Roll. On hit, the target takes piercing damage and makes a Constitution save. On a failure, it takes extra piercing damage at the start of each of its turns until it receives healing or a creature succeeds on a Medicine check to close the wound.",
  ...
  },
  {
    ...
    mechanics: "Recharge 5-6. Dexterity Saving Throw, one creature the monster can see within 60 feet. Failure: the target has the Restrained condition until the web is destroyed. The web has low AC and hit points, vulnerability to fire, and immunity to poison and psychic damage.",
  ...
  },
  {
    ...
    mechanics: "Recharge 5-6. Dexterity Saving Throw, one creature within 60 feet. Failure: the target has the Restrained condition until the web is destroyed. A restrained target takes slashing damage at the start of each of its turns. Shadow webs have higher AC and hit points than ordinary webs.",
  ...
  },
  {
    ...
    mechanics: "On a hit, the target makes a Constitution save. On a failure, its speed is reduced by 10 feet and it takes piercing damage at the start of its next turn. An action and a successful Medicine check ends the effect.",
  ...
  },
  {
    ...
    mechanics: "Trigger: a creature destroys an egg the monster is carrying. Response: roll a d6. On a 4 or higher, the monster enrages until the combat ends, gaining a bonus to attack rolls, damage rolls, speed, and jump distance.",
  ...
  },
  {
    ...
    mechanics: "All webs created by the creature have a bonus to AC and hit points, and they lose vulnerability to fire while the creature is not bloodied.",
  ...
  },
  {
    ...
    mechanics: "Whenever a creature is hit by one of the monster's web abilities or starts its turn restrained by its web, it takes acid damage equal to the monster's proficiency bonus.",
  ...
  },
  {
    ...
    mechanics: "The creature has advantage on Dexterity (Stealth) checks, and it can take the Hide action as a bonus action on each of its turns.",
  ...
  },
  {
    ...
    mechanics: "When the creature moves at least 5 feet on a slippery surface such as ice, oil, grease, or polished wet stone, it automatically fails checks made to keep its balance.",
  ...
  },
  {
    ...
    mechanics: "While within 30 feet of a fire with a radius greater than 10 feet, wildfire, or a similar blaze, the creature has the Frightened condition.",
  ...
  },
  {
    ...
    mechanics: "When the creature jumps, climbs from ceiling to wall, or is knocked prone, the next hit against it before the start of its next turn deals extra damage of the same type equal to 2d6.",
  ...
  },
  {
    ...
    mechanics: "A character can target the eyes with a called shot at a -5 penalty. On a hit, the creature has the Blinded condition until the end of its next turn. If the attack deals at least 30 damage, the blindness lasts until magically healed or until the creature finishes a short rest.",
  ...
  },
  {
    ...
    mechanics: "Before using its strongest attack, the brood shifts toward the target. A character who notices this can use a reaction to move 5 feet without provoking from the monster.",
  ...
  },
  {
    ...
    mechanics: "On death, each remaining egg hatches on a 13 or higher on a d20. Hatched eggs create spider minions in adjacent spaces. If the body was burned before death, this effect does not trigger.",
  ...
  },
  {
    ...
    mechanics: "On death, the body tears open nearby cocoons or drops its own silk-wrapped trophies. Searching the silk reveals one clue, treasure roll, or sign of a missing NPC.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, creatures without Web Walker have disadvantage on Dexterity saving throws and Dexterity (Acrobatics) checks until initiative count 20 on the next round.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, the creature casts or creates Web at a point it can see within 60 feet. While maintaining this effect, it cannot take other lair actions. A target that succeeds on the saving throw or escapes becomes immune to this lair action for 24 hours.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, choose a visible surface. Until cleared or burned, it becomes difficult terrain for creatures without Web Walker. Spiders attacking surprised targets on the surface have advantage.",
  ...
  // Gashadokuro support kept for source coverage
  {
    ...
    mechanics: "It has advantage on saves against being knocked prone. When it takes bludgeoning damage, its next attack deals -2 damage but gains 5 temporary hit points.",
  ...
  },
  {
    ...
    summary: "Its movement sounds too large for the space, as if something huge is crawling through a smaller body.",
    mechanics: "After it moves at least 15 feet, its next melee hit before the end of the turn pushes the target 5 feet and fills the vacated space with bone fragments, making it difficult terrain.",
  ...
  },
  {
    ...
    mechanics: "Recharge 5-6. Creatures in a 15-foot cone make a Dexterity save, taking piercing damage on a failure or half as much on a success.",
  ...
  },
  {
    ...
    mechanics: "The first time it drops to 0 hit points, it collapses instead. At initiative count 20 on the next round, it reforms with hit points equal to twice the party level unless its bones are scattered, burned, or sanctified first.",
  ...
  },
  {
    ...
    mechanics: "On death, its bones arrange into an arrow, a name, or a crude map pointing toward the next horror component in the location.",
  ...
  },
  {
    ...
    mechanics: "At initiative count 20, bone piles shift around one isolated creature. That creature makes a Strength save or is pulled 10 feet toward the monster.",
  ...
  // Wax Death Masks support kept for source coverage
  {
    ...
    mechanics: "The creature has resistance to cold damage but vulnerability to fire damage until it is bloodied.",
  ...
  },
  {
    ...
    mechanics: "When a creature first sees its face clearly, it makes a Wisdom save or cannot take reactions against this monster until the start of its next turn.",
  ...
  },
  {
    ...
    mechanics: "Once per round, when no conscious hostile creature has line of sight to it, it can move up to half its speed without provoking opportunity attacks.",
  ...
  },
  {
    ...
    mechanics: "When bloodied, choose one: Mourner Mask imposes disadvantage on opportunity attacks against it; Accuser Mask gives it +2 damage against frightened creatures; Saint Mask lets it end one condition on itself.",
  ...
  },
  {
    ...
    mechanics: "After the monster takes fire damage, the next attack against it before the start of its next turn has advantage.",
  ...
  },
  {
    ...
    mechanics: "On death, one creature that can see the mask makes a Wisdom save. On a failure, it is Frightened until the end of its next turn. If the mask was broken before death, this does not trigger.",
...
const FEATURE_COMPATIBILITY_OVERRIDES = {
  ...
  "volatile-immobile-mass": { grants: ["corpse_body", "bloated_body", "corpse_presence", "immobile_mass"], incompatibleWith: ["high_mobility", "web_dancer", "predatory_jump", "shadow_jump"] },
  ...
  "dangerously-unstable": { requires: ["bloated_body"], grants: ["unstable_body"], avoidWith: ["high_mobility", "stealth_predator"] },
  ...
  "incorporeal-movement": { grants: ["spirit_body"], incompatibleWith: ["egg_carrier", "barbed_chitin", "physical_chitin"] },
  ...
  "barbed-chitin": { grants: ["barbed_chitin", "physical_chitin"], incompatibleWith: ["spirit_body", "no_body"] },
...
const FEATURE_MECHANIC_OVERRIDES = {
  "acid-vomit": {
    mechanicTags: ["damage", "aoe", "ongoing_damage", "healing_denial", "recharge", "cleanup_action"],
    pressureTags: ["area", "control", "sustain"],
    complexityTags: ["recharge", "ongoing_tracking", "cleanup_action"],
    damageProfile: { baseDamage: 7, damageType: "Acid", expectedTargets: 2, roundWeight: [1, 0.35, 0.35] },
    usageProfile: { frequency: "recharge", recharge: "5-6" },
    conditionProfile: { condition: "Healing Denial", severity: "Major", duration: "until_cleaned", repeatSave: false },
  },
  "corpse-grab": {
    ...
    conditionProfile: { condition: "Restrained", severity: "Major", duration: "until_escape", repeatSave: true },
  },
  "unstable-rupture": {
    ...
    damageProfile: { baseDamage: 3, damageType: "Poison", expectedTargets: 2, roundWeight: [0.25, 0.25, 0.25] },
  ...
  "dangerously-unstable": {
    ...
    damageProfile: { baseDamage: 8, damageType: "Poison", expectedTargets: 3, roundWeight: [0.25, 0.25, 0.25] },
    usageProfile: { frequency: "reaction", trigger: "piercing_or_slashing_damage" },
    conditionProfile: { condition: "Prone", severity: "Moderate", duration: "instant", repeatSave: false },
  },
  "toxic-detonation": {
    mechanicTags: ["death_effect", "aoe", "condition", "save"],
    pressureTags: ["death_burst", "area"],
    complexityTags: ["death_trigger"],
    damageProfile: { baseDamage: 5, damageType: "Poison", expectedTargets: 2, roundWeight: [0, 0, 0] },
    usageProfile: { frequency: "death" },
    conditionProfile: { condition: "Poisoned", severity: "Minor", duration: "until_end_next_turn", repeatSave: false },
  },
  "grave-bite": {
    mechanicTags: ["attack", "damage", "healing"],
    pressureTags: ["sustain", "single_target"],
    complexityTags: ["conditional_healing"],
    damageProfile: { baseDamage: 4, damageType: "Piercing/Necrotic", expectedTargets: 1, roundWeight: [1, 1, 1] },
  ...
  "infected-bite": {
    ...
    damageProfile: { baseDamage: 5, damageType: "Poison/Necrotic", expectedTargets: 1, roundWeight: [1, 1, 1] },
    conditionProfile: { condition: "Exhaustion", severity: "Major", duration: "after_long_rest", repeatSave: false },
  },
  "purulent-bite": {
    ...
    damageProfile: { baseDamage: 6, damageType: "Poison/Necrotic", expectedTargets: 1, roundWeight: [1, 1, 1] },
    conditionProfile: { condition: "Exhaustion/Disease", severity: "Severe", duration: "weeks_or_until_cured", repeatSave: false },
  },
  "horrific-apparition": {
    ...
    damageProfile: { baseDamage: 2, damageType: "Psychic", expectedTargets: 3, roundWeight: [1, 0, 0] },
    conditionProfile: { condition: "Frightened", severity: "Moderate", duration: "until_start_next_turn", repeatSave: false },
  ...
  "corpse-tendrils": {
    ...
    conditionProfile: { condition: "Restrained", severity: "Major", duration: "1_minute", repeatSave: true },
  },
  "flesh-harvest": {
  ...
  "web-recharge": {
    ...
    usageProfile: { frequency: "recharge", recharge: "5-6" },
    conditionProfile: { condition: "Restrained", severity: "Major", duration: "until_web_destroyed", repeatSave: false },
  },
  "shadow-web": {
    ...
    damageProfile: { baseDamage: 2, damageType: "Slashing", expectedTargets: 1, roundWeight: [1, 0.5, 0.5] },
    usageProfile: { frequency: "recharge", recharge: "5-6" },
    conditionProfile: { condition: "Restrained", severity: "Major", duration: "until_web_destroyed", repeatSave: false },
  },
  "corrosive-web": {
    ...
    damageProfile: { baseDamage: 2, damageType: "Acid", expectedTargets: 1, roundWeight: [0.4, 0.4, 0.4] },
  },
  "egg-carrier": {
...
function getExpectedDpr(cr, tierId = "normal") {
  ...
  const base = cr < 20
    ? (legendaryLike ? 7.5 + 7.5 * cr : 6 + 6 * cr)
    : (legendaryLike ? 165 + 15 * (cr - 20) : 132 + 12 * (cr - 20));
  const tier = MONSTER_TIERS.find((item) => item.id === tierId) || MONSTER_TIERS[0];
...
function buildName(type, category, selectedFeatures) {
  const sourceFeature = selectedFeatures.find((f) => f.slot === "horror") || selectedFeatures.find((f) => f.slot === "body") || selectedFeatures[0];
...
function getPresetFeatureIds(preset) {
  return Object.values(normalizePresetSelection(preset)).flatMap((value) => Array.isArray(value) ? value : [value]);
}
...
function getPresetCoverage(preset) {
  ...
  return { slotCount, graftCount, percent: clamp(Math.round((slotCount / SLOTS.length) * 100), 0, 100) };
}
...
function getFeatureCompatibility(feature) {
  ...
  return {
    ...
    softRequires: uniqueArray([...asArray(feature.softRequires), ...asArray(override.softRequires)]),
    incompatibleWith: uniqueArray([...asArray(feature.incompatibleWith), ...asArray(override.incompatibleWith)]),
...
function getBaseTokens(typeId, category) {
  const normalizedCategory = String(category || "").toLowerCase().trim().split(" ").filter(Boolean).join("_");
  ...
  if (normalizedCategory.includes("spider")) tokens.push("spider_body", "climber", "web_maker", "web_terrain");
...
function getCompatibilityStatus(feature, selectedFeatures = [], typeId = "undead", category = "Zombie") {
  const compatibility = getFeatureCompatibility(feature);
  const grantedTokens = getGrantedTokens(selectedFeatures, typeId, category);
  const selectedBlocks = uniqueArray(selectedFeatures.flatMap((item) => getFeatureCompatibility(item).incompatibleWith));
  ...
  const missingSoftRequires = compatibility.softRequires.filter((token) => !grantedTokens.includes(token));
  ...
  return { kind: "compatible", label: "Compatible", tokens: [], message: "All requirements satisfied." };
}
...
function getFeatureDecisionProfile(feature, context = {}) {
  const status = context.status || { kind: "compatible", label: "Compatible", message: "All requirements satisfied." };
  ...
  const compatibility = getFeatureCompatibility(feature);
  const grantedTokens = getGrantedTokens(selectedFeatures, typeId, category);
  const synergyTokens = uniqueArray([...compatibility.requires, ...compatibility.softRequires].filter((token) => grantedTokens.includes(token)));
  ...
  const simple = feature.complexity <= 1 && Math.max(0, feature.cost) <= 3 && !complexityTags.some((tag) => ["reaction_trigger", "ongoing_tracking", "summon_tracking", "round_tracking", "delayed_tracking"].includes(tag));
  const highPressure = feature.cost >= 5 || (feature.stats?.dpr || 0) >= 6 || (feature.stats?.control || 0) >= 3 || counterplayProfile.burst || counterplayProfile.hardControl;
  const needsTell = highPressure && !hasSelectedSlot(selected, "weakness") && feature.slot !== "weakness";
  const bossOnly = (asArray(feature.roleBias).length > 0 && asArray(feature.roleBias).every((role) => role === "boss")) || section === "lairAction" || section === "legendaryAction";
  const risky = ["soft", "avoid", "missing", "incompatible"].includes(status.kind) || needsTell || (highPressure && feature.complexity >= 3);
  const blocked = ["missing", "incompatible"].includes(status.kind);
  const recommended = !blocked && !risky && !context.selectedInSlot && (currentSlotMatch || (currentSlot === "all" && slotEmpty)) && (simple || synergyTokens.length > 0 || Math.max(0, feature.cost) <= 4 || roleId === "boss");
  ...
  if ((feature.stats?.mobility || 0) >= 2) bestForParts.push(tacticalRoleId === "lurker" ? "Lurker" : "Skirmisher");
  if ((feature.stats?.dpr || 0) >= 5) bestForParts.push(tacticalRoleId === "artillery" ? "Artillery" : "Damage");
  ...
  const tier = blocked ? "blocked" : risky ? "risky" : recommended ? "recommended" : simple ? "simple" : "standard";
  const rank = (recommended ? 0 : simple ? 10 : risky ? 35 : 20)
...
function getFeatureSpiceScore(feature, profile) {
  const section = getFeatureSection(feature);
  const counterplayProfile = getFeatureCounterplayProfile(feature);
  const setpieceWeight = ["horror", "twist", "death", "lair"].includes(feature.slot) || ["reaction", "death", "lairAction", "legendaryAction"].includes(section) ? 8 : 0;
  return Math.max(0, feature.cost) * 2
...
function getFeatureSafetyScore(feature, profile) {
  const mechanicProfile = getFeatureMechanicProfile(feature);
  const counterplayProfile = getFeatureCounterplayProfile(feature);
  const trackingPenalty = mechanicProfile.complexityTags.filter((tag) => ["reaction_trigger", "ongoing_tracking", "summon_tracking", "round_tracking", "delayed_tracking", "object_tracking"].includes(tag)).length * 4;
  return 60
...
function buildSmartSlotPicks({ slotId, candidates, selected, selectedFeatures, typeId, category, roleId, tacticalRoleId, monsterTierId }) {
  if (!slotId || slotId === "all") return [];
  const slotCandidates = candidates
    .filter((feature) => feature.slot === slotId && !getSelectedIdsForSlot(selected, feature.slot).includes(feature.id))
    .map((feature) => {
  ...
  const recommended = take(
    ...
    [...slotCandidates].sort((a, b) => getFeatureDecisionRank(a.profile) - getFeatureDecisionRank(b.profile) || a.feature.title.localeCompare(b.feature.title))
  );
  ...
  const safe = take(
    ...
    [...slotCandidates]
      .filter(({ feature, profile }) => feature.complexity <= 2 && Math.max(0, feature.cost) <= 4 && !profile.blocked)
      .sort((a, b) => getFeatureSafetyScore(b.feature, b.profile) - getFeatureSafetyScore(a.feature, a.profile) || getFeatureDecisionRank(a.profile) - getFeatureDecisionRank(b.profile))
  );
  ...
  const spicy = take(
    ...
    [...slotCandidates]
      ...
      .sort((a, b) => getFeatureSpiceScore(b.feature, b.profile) - getFeatureSpiceScore(a.feature, a.profile) || b.feature.cost - a.feature.cost)
  );

  return [recommended, safe, spicy].filter(Boolean);
}

function buildFeatureImpactPreview({ feature, selected, selectedFeatures, typeId, category, computed }) {
  ...
  const featureMechanics = nextFeatures.map((item) => ({ id: item.id, title: item.title, ...getFeatureMechanicProfile(item) }));
  ...
  const nextPressureProfile = buildPressureProfile({ cost, monsterTier: computed.monsterTier, tempoProfile: computed.tempoProfile, statMods, mechanicsSummary, budget: computed.budget });
  const nextComplexityProfile = buildComplexityProfile({ complexity: rawComplexity, mechanicsSummary, featureMechanics, limit: computed.complexityCap });
  ...
  const pressureCrossesLimit = computed.pressure <= computed.budget && nextPressureProfile.score > computed.budget ? 1 : 0;
  const complexityCrossesLimit = computed.complexity <= computed.complexityCap && nextComplexityProfile.score > computed.complexityCap ? 1 : 0;
  const compatibilityWarning = ["missing", "incompatible"].includes(compatibility.kind) ? 1 : 0;
  const highPressureNeedsTell = !currentHasWeakness && feature.slot !== "weakness" && (feature.cost >= 5 || counterplayProfile.hardControl || counterplayProfile.burst) ? 1 : 0;

  let counterplay = "Neutral";
  if (feature.slot === "weakness" || counterplayProfile.hasNonDamageAnswer || counterplayProfile.hasBreakCondition) counterplay = "Improves";
  if (counterplayProfile.hardControl || counterplayProfile.burst) counterplay = currentHasWeakness ? "Needs Tell" : "Worsens";
  ...
  return {
    ...
    counterplay,
    warningsAdded: pressureCrossesLimit + complexityCrossesLimit + compatibilityWarning + highPressureNeedsTell,
...
function formatFeatureImpactPreview(impact) {
  ...
  if (impact.counterplay && impact.counterplay !== "Neutral") parts.push(`Counterplay ${impact.counterplay}`);
  if (impact.warningsCleared) parts.push(`Clears ${impact.warningsCleared}`);
  if (impact.warningsAdded) parts.push(`Adds ${impact.warningsAdded} warning${impact.warningsAdded === 1 ? "" : "s"}`);
  return parts.join(" · ");
}
...
function getFeatureMechanicProfile(feature) {
  ...
  const section = getFeatureSection(feature);
  const fallbackUsage = section === "reaction"
    ? { frequency: "reaction" }
    : section === "lairAction"
  ...
  return {
    ...
    mechanicTags: uniqueArray([...asArray(feature.mechanicTags), ...asArray(override.mechanicTags)]),
    pressureTags: uniqueArray([...asArray(feature.pressureTags), ...asArray(override.pressureTags)]),
    complexityTags: uniqueArray([...asArray(feature.complexityTags), ...asArray(override.complexityTags)]),
    damageProfile: override.damageProfile || feature.damageProfile || {
...
function summarizeMechanicProfiles(profiles) {
  ...
  const structuredDamage = profiles.reduce((sum, profile) => {
    ...
    const averageWeight = weights.reduce((total, value) => total + value, 0) / Math.max(1, weights.length);
    return sum + Math.max(0, damage.baseDamage || 0) * Math.max(1, damage.expectedTargets || 1) * averageWeight;
  }, 0);
  ...
  return {
    ...
    majorConditionCount: conditionProfiles.filter((profile) => ["Major", "Severe"].includes(profile.severity)).length,
...
function buildPressureProfile({ cost, monsterTier, tempoProfile, statMods, mechanicsSummary, budget }) {
  ...
  const breakdown = roundBreakdown({
    ...
    offense: Math.max(0, statMods.dpr || 0) * 0.2 + tagCount(pressureTags, "single_target") * 0.5 + tagCount(pressureTags, "reaction_burst") * 1.1 + tagCount(pressureTags, "burst") * 1.4,
    area: tagCount(pressureTags, "area") * 1 + tagCount(pressureTags, "death_burst") * 0.6,
    control: Math.max(0, statMods.control || 0) * 0.45 + tagCount(pressureTags, "control") * 0.9 + tagCount(pressureTags, "ranged_lockdown") * 1 + tagCount(pressureTags, "single_target_lockdown") * 1 + tagCount(pressureTags, "control_synergy") * 0.4,
    tempo: monsterTier.pressureMod * 0.55 + tempoProfile.pressureMod * 0.7 + tagCount(pressureTags, "tempo") * 1 + tagCount(pressureTags, "action_economy") * 1.1 + tagCount(pressureTags, "retaliation") * 0.8,
    defense: Math.max(0, statMods.hp || 0) / 28 + Math.max(0, statMods.ac || 0) * 0.85,
    sustain: tagCount(pressureTags, "sustain") * 0.8 + tagCount(pressureTags, "escalation") * 1 + tagCount(pressureTags, "campaign_pressure") * 0.5,
...
function buildComplexityProfile({ complexity, mechanicsSummary, featureMechanics, limit }) {
  ...
  const breakdown = roundBreakdown({
    ...
    actions: mechanicsSummary.rechargeCount * 0.55 + mechanicsSummary.reactionCount * 0.7 + mechanicsSummary.deathEffectCount * 0.35 + tagCount(complexityTags, "action_cost") * 0.6 + tagCount(complexityTags, "summon_tracking") * 0.8,
    timing: tagCount(complexityTags, "recharge") * 0.45 + tagCount(complexityTags, "reaction_trigger") * 0.65 + tagCount(complexityTags, "random_trigger") * 0.55 + tagCount(complexityTags, "death_trigger") * 0.35 + tagCount(complexityTags, "round_tracking") * 0.75 + tagCount(complexityTags, "delayed_tracking") * 0.7,
    conditions: mechanicsSummary.conditionCount * 0.35 + mechanicsSummary.majorConditionCount * 0.55 + tagCount(complexityTags, "condition_tracking") * 0.5 + tagCount(complexityTags, "repeat_save") * 0.65 + tagCount(complexityTags, "ongoing_tracking") * 0.65 + tagCount(complexityTags, "escape_check") * 0.55,
    environment: tagCount(complexityTags, "object_hp") * 0.65 + tagCount(complexityTags, "object_tracking") * 0.65 + tagCount(complexityTags, "corpse_anchor") * 0.55 + tagCount(complexityTags, "corpse_tracking") * 0.55 + tagCount(complexityTags, "terrain_anchor") * 0.45 + tagCount(complexityTags, "cleanup_action") * 0.55,
...
const COUNTERPLAY_TERMS = {
  telegraph: ["visible", "before", "obvious", "telegraph", "see", "shines", "creaks", "bulges", "distends", "leaks", "audible", "readable", "warning", "notices", "reveals"],
  breakCondition: ["save", "escape", "destroyed", "burned", "clean", "cleaned", "ends", "end the effect", "until", "action", "medicine", "healing", "removed", "short rest", "long rest"],
  nonDamageAnswer: ["fire", "radiant", "holy", "salt", "rite", "name", "true name", "bait", "corpse", "distance", "range", "cover", "light", "bright light", "burn", "destroy", "avoid", "move", "forced movement", "medicine", "healing", "clean", "antitoxin", "scouting", "watch", "formation", "readied"],
  positioning: ["distance", "range", "cover", "spacing", "formation", "avoid", "move", "position", "lane", "path", "surface", "terrain", "wall", "ceiling", "light"],
  prep: ["prepared", "bait", "holy water", "salt", "rite", "investigation", "scouting", "watch", "records", "offering", "antitoxin", "cleansing", "consecrated"],
};
...
function getFeatureCounterplayProfile(feature) {
  const mechanicProfile = getFeatureMechanicProfile(feature);
  const text = `${feature.summary || ""} ${feature.mechanics || ""} ${feature.counterplay || ""}`.toLowerCase();
  ...
  const hardControl = control >= 2 || majorCondition || mechanicProfile.mechanicTags.some((tag) => ["restrained", "grapple", "condition", "exhaustion", "healing_denial"].includes(tag));
  const burst = dpr >= 6 || mechanicProfile.pressureTags.some((tag) => ["burst", "death_burst", "reaction_burst"].includes(tag));
...
function summarizeCounterplayProfiles(profiles) {
  ...
  return {
    ...
    unresolvedOppressive: oppressive.filter((profile) => !profile.hasBreakCondition && !profile.hasNonDamageAnswer),
  };
}

function buildCounterplayAudit({ selected, roleId, monsterTier, pressureProfile, complexityProfile, mechanicsSummary, counterplayProfiles }) {
  ...
  if (!hasWeakness) {
    issues.push({ severity: "critical", label: "Missing Weakness / Tell", detail: "Add at least one explicit player-facing answer before using this as a horror monster." });
    recommendations.push("Add a Weakness / Tell graft with a visible trigger or non-damage solution.");
  }

  if (summary.unresolvedOppressive.length) {
    issues.push({ severity: "major", label: "Oppressive Grafts Need Answers", detail: summary.unresolvedOppressive.map((profile) => profile.title).join(", ") });
    recommendations.push("Give high-pressure grafts a break condition, destroyable object, repeat save, positioning answer, or preparation answer.");
  }

  if (summary.untelegraphedOppressive.length >= 2) {
    issues.push({ severity: "major", label: "Too Many Untelegraphed Threats", detail: summary.untelegraphedOppressive.map((profile) => profile.title).join(", ") });
    recommendations.push("Add visual, audio, timing, or behavior tells before the most punishing abilities resolve.");
  }

  if (mechanicsSummary.majorConditionCount >= 2 && summary.breakConditionCount < mechanicsSummary.majorConditionCount) {
    issues.push({ severity: "major", label: "Hard Conditions Need Release Valves", detail: "Major conditions outnumber clear break conditions." });
    recommendations.push("Prefer repeat saves, escape checks, destroyed anchors, visible setup, or one-round durations for hard control.");
  }

  if (mechanicsSummary.deathEffectCount && !hasDeath) {
    issues.push({ severity: "minor", label: "Implicit Death Pressure", detail: "Structured mechanics imply death pressure, but no Death Effect slot is occupied." });
  }

  if (pressureProfile.label === "Critical" && summary.nonDamageAnswerCount < 2) {
    issues.push({ severity: "critical", label: "Critical Pressure Needs Non-Damage Answers", detail: "The build is highly pressuring but has few non-damage answers." });
    recommendations.push("Add answers such as fire, radiant damage, distance, cover, bait, rites, medicine, object destruction, or light management.");
  }

  if (["boss", "legendary", "setpiece"].includes(monsterTier.id) && !hasLair && roleId === "boss") {
    issues.push({ severity: "minor", label: "Boss Has No Scene Counterplay", detail: "A boss can work without lair rules, but scene-level interaction would make counterplay clearer." });
  }
  ...
  return {
    score,
    rating: score >= 82 ? "Strong" : score >= 64 ? "Playable" : score >= 45 ? "Needs Work" : "Unsafe",
    summary,
    issues,
...
function getTopFeatureByWeight(features, weightFn) {
  return [...features].sort((a, b) => weightFn(b) - weightFn(a) || b.cost - a.cost || a.title.localeCompare(b.title))[0] || null;
}

function getOneClickFixCandidates({ slotId, selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, excludeFeatureId = "" }) {
  return FEATURES
    .map((feature) => ({ feature, status: getCompatibilityStatus(feature, selectedFeatures, typeId, category) }))
    ...
    .map(({ feature, status }) => {
      const profile = getFeatureDecisionProfile(feature, { status, selected, selectedFeatures, typeId, category, roleId, currentSlot: slotId });
...
function getBestAddFeatureFix(args) {
  ...
  const sorted = [...candidates].sort((a, b) => {
    if (args.slotId === "weakness") {
      return (b.feature.stats?.fairness || 0) - (a.feature.stats?.fairness || 0)
        || b.safety - a.safety
        || getFeatureDecisionRank(a.profile) - getFeatureDecisionRank(b.profile)
        || a.feature.title.localeCompare(b.feature.title);
    }
    return getFeatureDecisionRank(a.profile) - getFeatureDecisionRank(b.profile)
      || b.safety - a.safety
...
function getSelectedWithoutFeature(selected, feature) {
  ...
  const currentIds = getSelectedIdsForSlot(selected, feature.slot).filter((id) => id !== feature.id);
  const next = { ...selected };
...
function findReplacementFix({ feature, selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, reason = "pressure" }) {
  ...
  const originalWeight = reason === "complexity" ? getFeatureComplexityWeight(feature) : getFeaturePressureWeight(feature);
  const candidates = FEATURES
    .map((candidate) => ({ candidate, status: getCompatibilityStatus(candidate, reducedFeatures, typeId, category) }))
    .filter(({ candidate, status }) => {
      if (candidate.id === feature.id) return false;
      if (candidate.slot !== feature.slot) return false;
      if (getSelectedIdsForSlot(reducedSelected, candidate.slot).includes(candidate.id)) return false;
      const frameMatch = customMode
      ...
      const candidateWeight = reason === "complexity" ? getFeatureComplexityWeight(candidate) : getFeaturePressureWeight(candidate);
      return candidateWeight < originalWeight || candidate.cost < feature.cost || candidate.complexity < feature.complexity;
    })
    .map(({ candidate, status }) => ({
      feature: candidate,
      status,
      weight: reason === "complexity" ? getFeatureComplexityWeight(candidate) : getFeaturePressureWeight(candidate),
      profile: getFeatureDecisionProfile(candidate, { status, selected: reducedSelected, selectedFeatures: reducedFeatures, typeId, category, roleId, currentSlot: feature.slot }),
    }))
    .sort((a, b) => (originalWeight - b.weight) - (originalWeight - a.weight) || getFeatureDecisionRank(a.profile) - getFeatureDecisionRank(b.profile) || a.feature.title.localeCompare(b.feature.title));
  return candidates[0]?.feature || null;
}

function buildOneClickFixes({ issue, selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }) {
  const fixes = [];
  const pushFix = (fix) => {
    if (!fix) return;
    if (fixes.some((item) => item.kind === fix.kind && item.featureId === fix.featureId && item.addFeatureId === fix.addFeatureId && item.removeFeatureId === fix.removeFeatureId)) return;
    fixes.push(fix);
  };

  const weaknessFix = getBestAddFeatureFix({ slotId: "weakness", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode });
  const twistFix = getBestAddFeatureFix({ slotId: "twist", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode });
  const lairFix = getBestAddFeatureFix({ slotId: "lair", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode });
  ...
  if (["pressure", "damage", "hp"].includes(issue) && topPressureFeature) {
    const replacement = findReplacementFix({ feature: topPressureFeature, selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, reason: "pressure" });
    if (replacement) pushFix({ label: `Replace with ${replacement.title}`, kind: "replaceFeature", removeFeatureId: topPressureFeature.id, addFeatureId: replacement.id });
    pushFix({ label: `Remove ${topPressureFeature.title}`, kind: "removeFeature", featureId: topPressureFeature.id });
  }

  if (["complexity", "reactions"].includes(issue) && topComplexityFeature) {
    const replacement = findReplacementFix({ feature: topComplexityFeature, selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, reason: "complexity" });
    if (replacement) pushFix({ label: `Replace with ${replacement.title}`, kind: "replaceFeature", removeFeatureId: topComplexityFeature.id, addFeatureId: replacement.id });
    pushFix({ label: `Remove ${topComplexityFeature.title}`, kind: "removeFeature", featureId: topComplexityFeature.id });
  }

  if (issue === "boss-action") {
    if (twistFix) pushFix({ label: `Add ${twistFix.title}`, kind: "addFeature", featureId: twistFix.id });
    if (lairFix) pushFix({ label: `Add ${lairFix.title}`, kind: "addFeature", featureId: lairFix.id });
  }

  return fixes.slice(0, 2);
}

function buildBalanceRecommendations({ selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, monsterTier, tempoProfile, pressure, budget, complexity, complexityCap, counterplayAudit, mechanicsSummary, baseline, hp, dpr, effectiveProfile }) {
  const recommendations = [];
  ...
  const hasLair = hasSelectedSlot(selected, "lair");
  const nextTier = monsterTier.id === "normal" ? "elite" : monsterTier.id === "elite" ? "boss" : monsterTier.id === "boss" ? "legendary" : "setpiece";
  ...
  if (!hasWeakness) {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "missing-weakness", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
  ...
  if (pressure > budget) {
    addRecommendation({
      ...
      detail: topPressureFeature ? `${topPressureFeature.title} is the first graft to review.` : "The pressure score is above the current budget.",
      actions: [
        ...buildOneClickFixes({ issue: "pressure", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        topPressureFeature ? { label: `Open ${titleCase(topPressureFeature.slot)}`, kind: "slot", slotId: topPressureFeature.slot } : null,
  ...
  if (complexity > complexityCap) {
    addRecommendation({
      ...
      detail: topComplexityFeature ? `${topComplexityFeature.title} is the first tracking-heavy graft to review.` : "Complexity is above the current cap.",
      actions: [
        ...buildOneClickFixes({ issue: "complexity", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        topComplexityFeature ? { label: `Open ${titleCase(topComplexityFeature.slot)}`, kind: "slot", slotId: topComplexityFeature.slot } : null,
        { label: "Use Advanced Limits", kind: "advanced" },
      ].filter(Boolean),
    });
  }

  if (counterplayAudit.rating === "Unsafe" || counterplayAudit.issues.some((issue) => issue.severity === "critical")) {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "counterplay", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        { label: "Open Weakness Slot", kind: "slot", slotId: "weakness" },
      ],
    });
  }

  if (mechanicsSummary.majorConditionCount >= 2 && counterplayAudit.summary.breakConditionCount < mechanicsSummary.majorConditionCount) {
    addRecommendation({
      id: "condition-breaks",
      severity: "major",
      ...
      actions: [
        ...buildOneClickFixes({ issue: "conditions", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        { label: "Open Weakness Slot", kind: "slot", slotId: "weakness" },
      ],
    });
  }

  if (mechanicsSummary.reactionCount >= 3 && !["boss", "legendary", "setpiece"].includes(monsterTier.id)) {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "reactions", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        topComplexityFeature ? { label: `Open ${titleCase(topComplexityFeature.slot)}`, kind: "slot", slotId: topComplexityFeature.slot } : null,
  ...
  if (roleId === "boss" && !hasTwist && !hasLair) {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "boss-action", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
  ...
  if (hp > baseline.hp * 1.45 && monsterTier.id === "normal") {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "hp", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
        topPressureFeature ? { label: `Open ${titleCase(topPressureFeature.slot)}`, kind: "slot", slotId: topPressureFeature.slot } : null,
  ...
  if (dpr > baseline.dpr * 1.4 || effectiveProfile.burstDpr > baseline.dpr * 1.75) {
    addRecommendation({
      ...
      actions: [
        ...buildOneClickFixes({ issue: "damage", selected, selectedFeatures, typeId, category, roleId, sourceId, composerMode, customMode, topPressureFeature, topComplexityFeature }),
  ...
  if (tempoProfile.id === "legendary" && !["boss", "legendary", "setpiece"].includes(monsterTier.id)) {
    addRecommendation({
      id: "tempo-tier-mismatch",
      severity: "major",
      title: "Legendary tempo needs boss framing",
      detail: "Legendary tempo on a non-boss tier can feel overtuned. Slow the tempo or raise the monster tier to match the action economy.",
      actions: [
        { label: "Set Boss Tier", kind: "tier", tierId: "boss" },
...
function getForgePriority(roleId) {
  ...
  if (roleId === "boss") return ["body", "mind", "movement", "attack", "horror", "twist", "weakness", "lair", "death"];
...
const GUIDED_SLOT_PRIORITY = ["body", "attack", "weakness", "movement", "mind", "horror", "twist", "death", "lair"];

function classifyWarning(warning) {
  const text = String(warning || "").toLowerCase();
  if (text.includes("no weakness") || text.includes("missing") || text.includes("critical") || text.includes("unsafe") || text.includes("counterplay audit")) return "critical";
  if (text.includes("above") || text.includes("over") || text.includes("too many") || text.includes("high")) return "major";
  return "minor";
}
...
function buildGuidedFlow({ composerStarted, startMode, selected, computed, activePreset }) {
  ...
  const hasSetpieceSlot = ["twist", "death", "lair"].some((slotId) => hasSelectedSlot(selected, slotId));
  ...
  const recommendedSlotId = composerStarted ? GUIDED_SLOT_PRIORITY.find((slotId) => !hasSelectedSlot(selected, slotId)) || null : null;
  const recommendedSlot = recommendedSlotId ? SLOTS.find((slot) => slot.id === recommendedSlotId) : null;
  const recommendedDetail = recommendedSlotId ? slotDetails[recommendedSlotId] : null;
  const activePresetText = activePreset ? `${activePreset.label} loaded.` : startMode === "scratch" ? "Scratch build selected." : "Choose Template or Scratch.";
  ...
  if (composerStarted && recommendedSlotId) {
    nextAction = {
      ...
      detail: recommendedDetail?.detail || recommendedSlot?.hint || "Install the next useful graft.",
    ...
    nextAction = {
      ...
      detail: exportReady ? "The monster has core anatomy, counterplay, and clean balance checks." : "The monster is usable, but warnings remain in the balance review.",
      cta: "Open Export",
    };
  }
  ...
  const steps = [
    ...
    },
    {
      ...
      disabled: !composerStarted,
      detail: recommendedSlotId ? `Next useful slot: ${recommendedSlot?.label || "slot"}.` : "The anatomy has enough installed grafts for a complete monster.",
    },
    {
      id: "review",
      label: "Review",
      ...
      disabled: !composerStarted,
      detail: balanceReady ? "Balance and counterplay look playable." : "Review pressure, complexity, warnings, and counterplay.",
    },
    {
      id: "export",
      label: "Export",
  ...
  const highestReachedIndex = steps.reduce((highest, step, index) => step.reached ? Math.max(highest, index) : highest, 0);
...
function getStatBlockBasics(creatureType, category, role, computed, abilityProfile, xp) {
  const initiative = (abilityProfile.physical.find((row) => row.key === "dex")?.mod || 0) + (computed.tempoProfile?.initiativeMod || 0);
  ...
  const resistances = creatureType.id === "undead" ? "Necrotic; Bludgeoning, Piercing, and Slashing damage from nonmagical attacks" : creatureType.id === "beast" ? "Poison" : "Psychic, Necrotic";
  const immunities = creatureType.id === "undead" ? "Poison damage; Poisoned condition" : creatureType.id === "beast" ? "None" : "Charmed and Frightened conditions";
  const skills = creatureType.id === "beast" ? `Perception ${modText(computed.prof + 2)}, Stealth ${modText(computed.prof + 2)}` : creatureType.id === "aberration" ? `Insight ${modText(computed.prof + 2)}, Perception ${modText(computed.prof + 2)}` : `Perception ${modText(computed.prof)}`;
  const languages = creatureType.id === "beast" ? "None" : creatureType.id === "undead" ? "Understands the languages it knew in life but can’t speak" : "Deep Speech or telepathy 60 ft.";
...
function exportItems(items, fallback, computed) {
  return (items.length ? items : fallback).map((item) => `${item.title}. ${normalizeRulesText(item.mechanics, computed)}`).join(String.fromCharCode(10));
}
...
function normalizeConditionWording(text) {
  ...
  ["Blinded", "Charmed", "Deafened", "Frightened", "Grappled", "Incapacitated", "Invisible", "Paralyzed", "Petrified", "Poisoned", "Prone", "Restrained", "Stunned", "Unconscious"].forEach((condition) => {
...
function normalizeSaveWording(text, computed) {
  ...
  ["Strength", "Dexterity", "Constitution", "Intelligence", "Wisdom", "Charisma"].forEach((ability) => {
    output = replaceAllText(output, `${ability} Saving Throw, `, `${ability} Saving Throw: DC ${computed.dc}, `);
    output = replaceAllText(output, `${ability} save`, `${ability} Saving Throw`);
  });
  output = replaceAllText(output, "Strength or Dexterity save", "Strength or Dexterity Saving Throw");
  return output;
}
...
function normalizeAttackWording(text, computed) {
  if (!computed) return text;
  let output = String(text || "");
  output = replaceAllText(output, "Melee Attack Roll. On hit, ", `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit: `);
  output = replaceAllText(output, "Melee Attack Roll. On hit,", `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit:`);
  output = replaceAllText(output, "Melee Attack Roll.", `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit:`);
  output = replaceAllText(output, "On a hit, ", "Hit: ");
  output = replaceAllText(output, "On hit, ", "Hit: ");
  output = replaceAllText(output, "Ranged Attack Roll, range ", `Ranged Attack Roll: ${modText(computed.attack)}, range `);
  return output;
}
...
function normalizeMonsterReferences(text, computed = null) {
  ...
  return substitutions.reduce((output, [search, replacement]) => replaceAllText(output, search, replacement), String(text || ""));
}

function normalizeRulesText(text, computed = null) {
  return normalizeMonsterReferences(normalizeConditionWording(normalizeSaveWording(normalizeAttackWording(text, computed), computed)), computed)
    .split("  ").join(" ")
    .trim();
}
...
function buildExportReadiness({ computed, selected, selectedFeatures, traits, actions, weaknessFeatures, deathEffects, lairActions }) {
  const checks = [
    {
      id: "core-anatomy",
      label: "Core Anatomy",
      detail: "Body + Attack + Weakness / Tell",
      ready: hasSelectedSlot(selected, "body") && hasSelectedSlot(selected, "attack") && hasSelectedSlot(selected, "weakness"),
      severity: "required",
    },
    {
      id: "main-action",
    ...
    },
    {
      ...
      ready: weaknessFeatures.length > 0 && ["Strong", "Playable"].includes(computed.counterplayAudit.rating),
      severity: "required",
    },
    {
      id: "pressure",
    ...
    },
    {
      id: "warnings",
      label: "Warnings",
      detail: computed.warnings.length ? `${computed.warnings.length} issue${computed.warnings.length === 1 ? "" : "s"}` : "No active warnings",
    ...
    },
    {
      id: "handoff-depth",
      label: "DM Handoff",
      detail: deathEffects.length || lairActions.length ? "Setpiece beats included" : "Core stat block only",
  ...
  return {
    ...
    percent: clamp(Math.round((checks.filter((check) => check.ready).length / Math.max(1, checks.length)) * 100), 0, 100),
  };
}

function buildExportRunSheet({ computed, selectedFeatures, traits, actions, bonusActions, reactions, deathEffects, lairActions }) {
  const topPressureFeature = getTopFeatureByWeight(selectedFeatures, getFeaturePressureWeight);
  const topComplexityFeature = getTopFeatureByWeight(selectedFeatures, getFeatureComplexityWeight);
  ...
  return [
    { label: "Open With", value: horror ? horror.title : movement ? movement.title : mainAction ? mainAction.title : computed.name },
    { label: "Default Turn", value: mainAction ? mainAction.title : "Use the fallback Strike action" },
    { label: "Watch Closely", value: topPressureFeature ? topPressureFeature.title : "No high-pressure graft yet" },
    { label: "Table Load", value: topComplexityFeature ? topComplexityFeature.title : "Low tracking load" },
    { label: "Player Answer", value: weakness ? weakness.title : "Add a Weakness / Tell before final use" },
    { label: "Off-Turn Hook", value: reaction ? reaction.title : lair ? lair.title : "None" },
    { label: "Death Beat", value: death ? death.title : "None" },
    { label: "Rules Sections", value: `${traits.length} Traits · ${actions.length} Actions · ${bonusActions.length} Bonus · ${reactions.length} Reactions · ${lairActions.length} Lair` },
  ];
}
...
function getRunFeatureTrigger(feature, computed = null) {
  ...
  if (/initiative count 20/i.test(mechanics) || section === "lairAction") return "Initiative count 20";
...
function isRunTriggerFeature(feature) {
  ...
  return ["reaction", "bonusAction", "lairAction", "death"].includes(section)
    || /recharge|bloodied|drops to 0 hit points|on death|initiative count 20|trigger:/i.test(feature.mechanics || "");
}
...
function buildRunTriggerItems({ selectedFeatures, bonusActions, reactions, lairActions, deathEffects, computed }) {
  ...
  return triggerPool
    ...
    .sort((a, b) => {
      const order = { "Lair Actions": 0, "Reactions": 1, "Bonus Actions": 2, "Death Effects": 3, "Traits": 4, "Actions": 5 };
      return (order[a.section] ?? 9) - (order[b.section] ?? 9) || a.title.localeCompare(b.title);
    });
}

function buildRunTrackingItems({ computed, selectedFeatures, actions, bonusActions, reactions, lairActions, deathEffects }) {
  const rechargeItems = uniqueFeatures(selectedFeatures.filter((feature) => /recharge/i.test(feature.mechanics || "")));
  ...
  const objectItems = selectedFeatures.filter((feature) => {
    ...
    return profile.mechanicTags.some((tag) => ["destroyable_anchor", "corpse_requirement", "egg_requirement"].includes(tag))
      || profile.complexityTags.some((tag) => ["object_hp", "object_tracking", "corpse_anchor", "corpse_tracking", "terrain_anchor", "summon_tracking"].includes(tag));
  });

  const tracking = [
    { label: "HP State", value: `HP ${computed.hp}; watch bloodied at ${Math.floor(computed.hp / 2)}.` },
    { label: "Recharge", value: rechargeItems.length ? rechargeItems.map((feature) => feature.title).join(", ") : "None." },
    { label: "Conditions", value: conditionItems.length ? conditionItems.map(({ feature, profile }) => `${feature.title}: ${profile.conditionProfile.condition}`).join("; ") : "None." },
    { label: "Objects / Terrain", value: objectItems.length ? objectItems.map((feature) => feature.title).join(", ") : "None." },
    { label: "Off-Turn Rules", value: reactions.length || lairActions.length ? `${reactions.length} reaction${reactions.length === 1 ? "" : "s"}; ${lairActions.length} lair action${lairActions.length === 1 ? "" : "s"}.` : "None." },
    { label: "Death", value: deathEffects.length ? deathEffects.map((feature) => feature.title).join(", ") : "No death trigger." },
  ];

  return tracking.filter((item) => item.value);
}

function buildRunModeSheet({ name, creatureType, category, role, danger, computed, selectedFeatures, traits, actions, bonusActions, reactions, lairActions, deathEffects }) {
  const mainAction = actions.find((feature) => feature.slot === "attack") || actions[0] || selectedFeatures.find((feature) => feature.slot === "attack");
  const opener = actions.find((feature) => getFeatureMechanicProfile(feature).usageProfile?.frequency === "encounter_opener") || selectedFeatures.find((feature) => feature.slot === "horror") || mainAction;
  const movement = selectedFeatures.find((feature) => feature.slot === "movement");
  ...
  const topPressureFeature = getTopFeatureByWeight(selectedFeatures, getFeaturePressureWeight);
  const topComplexityFeature = getTopFeatureByWeight(selectedFeatures, getFeatureComplexityWeight);
  const actionFallback = { id: "fallback-strike", title: "Strike", summary: "Use the baseline attack when no action graft is installed.", mechanics: `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit: ${computed.damageText} damage.` };
  ...
  return {
    ...
    turnLoop: [
      {
        label: "Open",
        value: opener ? `${opener.title}. ${compactRunText(opener.summary || opener.mechanics, computed, 150)}` : "Reveal the threat and establish its strongest visible tell.",
      },
      {
        label: "Default Turn",
      ...
      {
        label: "Move",
        value: movement ? `${movement.title}. ${compactRunText(movement.summary || movement.mechanics, computed, 150)}` : "Advance directly, hold a threatening lane, or force the party to reposition.",
      },
      {
        label: "When Pressed",
        value: twist ? `${twist.title}. ${compactRunText(twist.summary || twist.mechanics, computed, 150)}` : topPressureFeature ? `Protect the table from ${topPressureFeature.title}: telegraph before it resolves.` : "Use the clearest installed graft, not every rule at once.",
      },
      {
        label: "End Beat",
        value: death ? `${death.title}. ${compactRunText(death.summary || death.mechanics, computed, 150)}` : "Let the death reveal a clue, consequence, or safe ending.",
      },
    ],
    triggers: buildRunTriggerItems({ selectedFeatures, bonusActions, reactions, lairActions, deathEffects, computed }),
    tracking: buildRunTrackingItems({ computed, selectedFeatures, actions, bonusActions, reactions, lairActions, deathEffects }),
    playerAnswers: weaknessFeatures.length
      ? weaknessFeatures.map((feature) => ({
        id: feature.id,
        title: feature.title,
        value: compactRunText(feature.counterplay || feature.mechanics || feature.summary, computed, 170),
      }))
      : computed.counterplayAudit.recommendations.map((value, index) => ({ id: `counterplay-${index}`, title: "Needed Answer", value })),
    watch: [
      topPressureFeature ? { label: "Pressure", value: `${topPressureFeature.title}: ${compactRunText(topPressureFeature.summary || topPressureFeature.mechanics, computed, 150)}` } : null,
      topComplexityFeature ? { label: "Tracking", value: `${topComplexityFeature.title}: keep its rule visible while running.` } : null,
      computed.warnings[0] ? { label: "Warning", value: computed.warnings[0] } : null,
    ].filter(Boolean),
  };
}

function buildNormalizedSections({ traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, computed }) {
  return {
    traits: traits.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    actions: actions.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    bonusActions: bonusActions.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    reactions: reactions.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    legendaryActions: legendaryActions.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    lairActions: lairActions.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
    deathEffects: deathEffects.map((item) => ({ title: item.title, text: normalizeRulesText(item.mechanics, computed) })),
  };
}
...
function buildStructuredFeature(feature, computed = null) {
  ...
  return {
    ...
    migration: {
      ...
      hasInlineCompatibility: Boolean(feature.grants || feature.requires || feature.softRequires || feature.incompatibleWith || feature.avoidWith),
      hasInlineMechanics: Boolean(feature.mechanicTags || feature.pressureTags || feature.complexityTags || feature.damageProfile || feature.usageProfile || feature.conditionProfile),
...
function getFeatureCatalogStats(features = FEATURES) {
  ...
  return {
    ...
    usingCompatibilityOverrides: structured.filter((feature) => feature.migration.usesCompatibilityOverride).length,
    usingMechanicOverrides: structured.filter((feature) => feature.migration.usesMechanicOverride).length,
    inlineCompatibility: structured.filter((feature) => feature.migration.hasInlineCompatibility).length,
...
function getPresetCatalogStats(presets = MONSTER_FAMILY_PRESETS) {
  return {
    ...
    averageGrafts: presets.length ? Math.round(presets.reduce((sum, preset) => sum + getPresetCoverage(preset).graftCount, 0) / presets.length) : 0,
  };
}

function buildExportText({ name, creatureType, category, role, danger, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, hasLegendaryActions, xp }) {
  const basics = getStatBlockBasics(creatureType, category, role, computed, abilityProfile, xp);
  const fallbackTraits = [{ title: "Unfinished Horror", mechanics: "Add grafts in the Crucible to generate traits, tells, weaknesses, and horror behavior." }];
  const fallbackActions = [{ title: "Strike", mechanics: `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit: ${computed.damageText} damage.` }];
  const sections = [
    name,
    basics.creatureLine,
    "",
  ...
  if (bonusActions.length) sections.push("", "Bonus Actions", exportItems(bonusActions, [], computed));
  if (reactions.length) sections.push("", "Reactions", exportItems(reactions, [], computed));
  if (deathEffects.length) sections.push("", "Death Effects", exportItems(deathEffects, [], computed));
  if (lairActions.length) sections.push("", "Lair Actions", exportItems(lairActions, [], computed));
  if (legendaryActions.length) sections.push("", "Legendary Actions", exportItems(legendaryActions, [], computed));
  else if (hasLegendaryActions) sections.push("", "Legendary Actions", "Legendary Action Uses: 3. Immediately after another creature’s turn, the monster can expend a use to move, attack, or trigger one selected horror graft. It regains all expended uses at the start of each of its turns.", "Press the Horror. The monster uses one non-lair graft that has not already been used this round.");
...
function buildRenderableStatBlock({ name, creatureType, category, role, danger, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, selectedFeatures, hasLegendaryActions, xp }) {
  const basics = getStatBlockBasics(creatureType, category, role, computed, abilityProfile, xp);
  const fallbackTraits = [{ id: "unfinished-horror", title: "Unfinished Horror", mechanics: "Add grafts in the Crucible to generate traits, tells, weaknesses, and horror behavior." }];
  const fallbackActions = [{ id: "fallback-strike", title: "Strike", mechanics: `Melee Attack Roll: ${modText(computed.attack)}, reach 5 ft. Hit: ${computed.damageText} damage.` }];
  ...
  const legendaryFallback = hasLegendaryActions && !legendaryActions.length
    ? [
      { id: "legendary-action-uses", title: "Legendary Action Uses", mechanics: "3. Immediately after another creature’s turn, the monster can expend a use to move, attack, or trigger one selected horror graft. It regains all expended uses at the start of each of its turns." },
      { id: "press-the-horror", title: "Press the Horror", mechanics: "The monster uses one non-lair graft that has not already been used this round." },
    ]
    : [];
  ...
  return {
    ...
    coreStats: [
      { label: "AC", value: computed.ac },
      { label: "HP", value: `${computed.hp} (${hpFormula(computed.hp, role.id === "boss" ? 10 : 8)})` },
      { label: "Speed", value: creatureType.defaults.speed },
    ...
    sections: [
      { id: "traits", title: "Traits", items: buildStatBlockItems(traitItems.length ? traitItems : fallbackTraits, computed) },
      { id: "weaknesses", title: "Weakness / Tell", items: buildStatBlockItems(weaknessItems, computed), highlight: true },
      { id: "actions", title: "Actions", items: buildStatBlockItems(actions.length ? actions : fallbackActions, computed) },
      { id: "bonus-actions", title: "Bonus Actions", items: buildStatBlockItems(bonusActions, computed) },
      { id: "reactions", title: "Reactions", items: buildStatBlockItems(reactions, computed) },
      { id: "death-effects", title: "Death Effects", items: buildStatBlockItems(deathEffects, computed) },
      { id: "lair-actions", title: "Lair Actions", items: buildStatBlockItems(lairActions, computed) },
      { id: "legendary-actions", title: "Legendary Actions", items: buildStatBlockItems(legendaryActions.length ? legendaryActions : legendaryFallback, computed) },
    ],
...
function buildExportJson({ name, creatureType, category, role, danger, source, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, selectedFeatures, activePreset, xp }) {
  const basics = getStatBlockBasics(creatureType, category, role, computed, abilityProfile, xp);
  const normalizedSections = buildNormalizedSections({ traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, computed });
...
export default function CruorMonsterComposerMvp() {
  ...
  const tacticalRole = TACTICAL_ROLES.find((item) => item.id === tacticalRoleId) || TACTICAL_ROLES[0];
  const monsterTier = MONSTER_TIERS.find((item) => item.id === monsterTierId) || MONSTER_TIERS[0];
  const tempoProfile = TEMPO_PROFILES.find((item) => item.id === tempoProfileId) || TEMPO_PROFILES[1];
  const defaultPressureBudget = role.budget + danger.budgetOffset + monsterTier.budgetOffset + tacticalRole.budgetMod + tempoProfile.budgetMod + Math.max(0, partySize - 4);
  const defaultComplexityCap = role.complexityCap + monsterTier.complexityCapOffset + tacticalRole.complexityMod + tempoProfile.complexityMod;
  ...
  const currentNavigatorSlot = componentNavigatorMode === "global" ? navigatorSlotFilter : activeSlot;
  ...
  const availableFeatures = useMemo(() => {
    ...
    return FEATURES
      ...
      .sort((a, b) => {
        const aDecision = getFeatureDecisionProfile(a.feature, { status: a.status, selected, selectedFeatures, typeId, category, roleId, tacticalRoleId, monsterTierId, currentSlot: currentNavigatorSlot });
        const bDecision = getFeatureDecisionProfile(b.feature, { status: b.status, selected, selectedFeatures, typeId, category, roleId, tacticalRoleId, monsterTierId, currentSlot: currentNavigatorSlot });
        const slotSort = SLOTS.findIndex((slot) => slot.id === a.feature.slot) - SLOTS.findIndex((slot) => slot.id === b.feature.slot);
        return getFeatureDecisionRank(aDecision) - getFeatureDecisionRank(bDecision) || slotSort || a.feature.cost - b.feature.cost || a.feature.title.localeCompare(b.feature.title);
      })
      .map(({ feature }) => feature);
  }, [sourceId, typeId, roleId, currentNavigatorSlot, selectedFeatures, selected, category, composerMode, customMode, tacticalRoleId, monsterTierId]);
  ...
  const computed = useMemo(() => {
    ...
    const complexityProfile = buildComplexityProfile({ complexity: rawComplexity, mechanicsSummary, featureMechanics, limit: effectiveComplexityCap });
    ...
    const estimatedCr = clamp(Math.round(targetCr + (pressure - budget) / 6 + (effectiveProfile.effectiveDpr3Round - baseline.dpr) / Math.max(8, baseline.dpr) * 2), 0, 30);
    ...
    const warnings = [];
    if (pressure > budget) warnings.push("Threat budget is above target. Reduce one high-cost twist or treat this as a boss/setpiece.");
    if (complexity > effectiveComplexityCap) warnings.push("Table complexity is high. Remove one feature with a reaction, recharge, or delayed effect, or increase the custom Complexity limit in Advanced Mode.");
    if (!hasSelectedSlot(selected, "weakness")) warnings.push("No Weakness / Tell selected. Add counterplay before using this as horror, otherwise it may feel arbitrary.");
    if (roleId === "boss" && !hasSelectedSlot(selected, "twist") && !hasSelectedSlot(selected, "lair")) warnings.push("Boss lacks action-economy pressure. Add a Combat Twist, Lair Effect, or minions.");
    if ((statMods.control || 0) >= 5 && !hasSelectedSlot(selected, "weakness")) warnings.push("Control pressure is high and currently has no clear player-facing answer.");
    if (roleId === "minion" && complexity > 4) warnings.push("Minions should be simple. Keep only one memorable feature.");
    if (hp > baseline.hp * 1.45 && monsterTier.id === "normal") warnings.push("HP is far above the normal CR baseline. Consider Elite, Boss, Legendary, or reduce defensive grafts.");
    if (dpr > baseline.dpr * 1.4 && monsterTier.id !== "legendary") warnings.push("Printed DPR is far above baseline. Treat this as an Elite/Boss profile or reduce offensive grafts.");
    if (effectiveProfile.effectiveDpr3Round > baseline.dpr * 1.35 && monsterTier.id === "normal") warnings.push("Effective DPR is above the normal CR baseline once control, mobility, and tempo are considered. Consider Elite/Boss tier or lower offensive pressure.");
    if (effectiveProfile.burstDpr > baseline.dpr * 1.75) warnings.push("Burst DPR spike is high. Add a recharge, telegraph, setup requirement, or reduce opening damage.");
    if (effectiveProfile.combatPowerEstimate > baselinePower * 1.7 && monsterTier.id === "normal") warnings.push("Effective combat power is much higher than baseline. Consider raising Tier or lowering HP/DPR/control grafts.");
    if (tempoProfile.id === "legendary" && !["boss", "legendary", "setpiece"].includes(monsterTier.id)) warnings.push("Legendary tempo on a non-boss tier can feel overtuned. Consider Boss, Legendary, or a slower tempo profile.");
    if (mechanicsSummary.rechargeCount >= 3) warnings.push("Too many recharge abilities. Consider converting one recharge effect into an at-will minor action or a phase trigger.");
    if (mechanicsSummary.reactionCount >= 3 && !["boss", "legendary", "setpiece"].includes(monsterTier.id)) warnings.push("Too many reaction hooks for a non-boss monster. Reduce reactions or raise the monster Tier.");
    if (mechanicsSummary.majorConditionCount >= 3) warnings.push("Major condition load is high. Make sure at least one condition has a clear break condition, repeat save, or visible setup.");
    counterplayAudit.issues.forEach((issue) => {
      warnings.push(`Counterplay Audit: ${issue.label}. ${issue.detail}`);
    });

    selectedFeatures.forEach((feature) => {
      const compatibilityWarning = buildCompatibilityWarning(feature, getCompatibilityStatus(feature, selectedFeatures, typeId, category));
  ...
  }, [partyLevel, role, roleId, danger, creatureType, selectedFeatures, selected, typeId, category, sourceId, composerMode, customMode, effectivePressureBudget, effectiveComplexityCap, targetCr, tacticalRole, monsterTier, tempoProfile]);
  ...
  function applyPreset(preset) {
    if (!preset) return;
    const presetType = CREATURE_TYPES.find((type) => type.id === preset.typeId) || CREATURE_TYPES[0];
    const nextCategory = presetType.categories.includes(preset.category) ? preset.category : presetType.categories[0];
  ...
  function forgeMonster() {
    ...
    priority.forEach((slotId) => {
      ...
      for (let index = 0; index < slotCap; index += 1) {
        ...
        const candidates = FEATURES
          .map((feature) => ({ feature, status: getCompatibilityStatus(feature, partialFeatures, typeId, category) }))
          .filter(({ feature, status }) => {
            const alreadyPicked = picks.includes(feature.id) || getSelectedIdsForSlot(next, slotId).includes(feature.id);
            const frameMatch = customMode
              ? featureMatchesSourceAndSlot(feature, sourceId, slotId)
              : featureMatchesFrame(feature, sourceId, typeId, roleId, slotId);
            return !alreadyPicked && frameMatch && canShowFeatureForMode(status, composerMode);
          })
          .sort((a, b) => getCompatibilityRank(a.status) - getCompatibilityRank(b.status) || a.feature.cost - b.feature.cost)
          .map(({ feature }) => feature);
  ...
  const activeSlotFeatures = activeSlotFeatureIds.map((id) => FEATURES.find((feature) => feature.id === id)).filter(Boolean);
  ...
  const activeAlternatives = activeSlotAvailableFeatures.filter((feature) => !activeSlotFeatureIds.includes(feature.id)).length;
  ...
  const guidedFlow = buildGuidedFlow({ composerStarted, startMode, selected, computed, activePreset });
  ...
  function handleAddFeatureFromNavigator(feature) {
    addFeature(feature);
    if (componentNavigatorMode === "slot" && !(advancedMode && getSlotCap(slotCaps, feature.slot) > 1)) {
      setComponentNavigatorOpen(false);
    }
  }

  return (
    <div className="monster-shell" data-composer-started={composerStarted ? "true" : "false"} data-start-mode={startMode || "unstarted"} data-template-picker-open={templatePickerOpen ? "true" : "false"}>
      <CruorStyle />
      ...
      <header className="app-shell__bar monster-shell__bar">
        ...
        <nav className="app-shell__nav" aria-label="Primary sections">
          <button className="app-shell__nav-item" type="button">Darken a Location</button>
          <button className="app-shell__nav-item is-active" type="button" aria-current="page">Monster Composer</button>
          <button className="app-shell__nav-item" type="button">Inspirations</button>
        </nav>
      </header>
      ...
      <main className="monster-workspace">
          ...
          <header className="darken-topbar monster-topbar">
            <div className="darken-topbar__primary">
              ...
              <div className="darken-topbar__control-row monster-topbar__control-row">
                <div className="mode-switch darken-topbar__mode-switch" aria-label="Choose what you need to do">
                  <button className="mode-btn" type="button" aria-label="Darken a Location" aria-pressed="false">
                    <BookOpen aria-hidden="true" />
                    <span className="sr-only">Darken a Location</span>
                  </button>
                  <button className="mode-btn active" type="button" aria-label="Build a Monster" aria-pressed="true">
                    <Skull aria-hidden="true" />
                    <span className="sr-only">Build a Monster</span>
                  </button>
                  <button className="mode-btn" type="button" aria-label="Inspirations" aria-pressed="false">
                ...
                <div className="monster-topbar__right">
                  <div className="monster-topbar__summary" aria-label="Current monster frame">
                    <span className="monster-current-frame">
                      {activePreset ? `${activePreset.label} · ` : ""}CR {targetCr} · {tacticalRole.label} · {monsterTier.label} · {tempoProfile.label}
                    </span>
                  </div>
                  <div className="darken-workspace__tabs" role="tablist" aria-label="Monster composer views">
                    <button className={`darken-workspace__tab ${viewMode === "composer" ? "is-active" : ""}`} type="button" role="tab" aria-selected={viewMode === "composer"} onClick={() => setViewMode("composer")}>Composer</button>
                    <button className={`darken-workspace__tab ${viewMode === "balance" ? "is-active" : ""}`} type="button" role="tab" aria-selected={viewMode === "balance"} onClick={() => setViewMode("balance")}>Balance</button>
                    <button className={`darken-workspace__tab ${viewMode === "run" ? "is-active" : ""}`} type="button" role="tab" aria-selected={viewMode === "run"} onClick={() => setViewMode("run")}>Run</button>
                    <button className={`darken-workspace__tab ${viewMode === "export" ? "is-active" : ""}`} type="button" role="tab" aria-selected={viewMode === "export"} onClick={() => setViewMode("export")}>Export</button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <aside className={`panel navigator monster-frame-drawer game-frame-drawer ${frameOpen ? "is-open" : ""}`} aria-label="Monster Frame" aria-hidden={!frameOpen}>
          <div className="game-frame__hero">
            <div className="game-frame__status-row">
              <span className="game-frame__status"><span /> Live Frame</span>
              <button className="icon-btn" type="button" aria-label="Close Monster Frame" onClick={() => setFrameOpen(false)}>
                <X aria-hidden="true" />
              </button>
            </div>
            ...
            <div className="game-frame__loadout" aria-label="Current frame summary">
              <span><Skull aria-hidden="true" /> {creatureType.label}</span>
              <span><Activity aria-hidden="true" /> {category}</span>
              <span><Sword aria-hidden="true" /> {role.label}</span>
              <span><Gauge aria-hidden="true" /> CR {targetCr}</span>
              <span><Activity aria-hidden="true" /> {tacticalRole.label}</span>
              <span><Sparkles aria-hidden="true" /> {monsterTier.label}</span>
              <span><AlertTriangle aria-hidden="true" /> {tempoProfile.label}</span>
            </div>
          </div>
          ...
          <div className="game-frame__body">
            <PanelGroup title="Creature Type" icon={Skull}>
              <div className="game-type-grid">
                {CREATURE_TYPES.map((type) => {
                  ...
                  return (
                    <button key={type.id} type="button" className={`game-type-card ${active ? "active" : ""}`} onClick={() => selectType(type.id)}>
                      <span className="game-type-card__icon"><Icon aria-hidden="true" /></span>
              ...
              <div className="game-category-panel">
                ...
                <div className="game-category-grid" role="radiogroup" aria-label="Creature category">
            ...
            <PanelGroup title="Encounter Role" icon={Sword}>
              <div className="game-role-grid">
                {ROLES.map((item) => (
                  <button key={item.id} type="button" className={`game-role-card ${item.id === roleId ? "active" : ""}`} onClick={() => {
                      setRoleId(item.id);
                      setActivePresetId("");
                    }}>
            ...
            <PanelGroup title="Design Profile" icon={Gauge}>
              <div className="game-category-panel">
                ...
                <NumberField label="Target CR" value={targetCr} min={0} max={30} onChange={(value) => {
                  setTargetCr(value);
                  setActivePresetId("");
                }} />
              </div>
              ...
              <div className="game-category-panel">
                <div className="game-frame__minihead"><span>Tactical Role</span><strong>{tacticalRole.label}</strong></div>
                <div className="game-category-grid" role="radiogroup" aria-label="Tactical role">
                  {TACTICAL_ROLES.map((item) => (
                    <button key={item.id} type="button" role="radio" aria-checked={item.id === tacticalRoleId} className={`game-category-chip ${item.id === tacticalRoleId ? "active" : ""}`} onClick={() => {
              ...
              <div className="game-category-panel">
                <div className="game-frame__minihead"><span>Tier</span><strong>{monsterTier.label}</strong></div>
                <div className="game-category-grid" role="radiogroup" aria-label="Monster tier">
                  {MONSTER_TIERS.map((item) => (
                    <button key={item.id} type="button" role="radio" aria-checked={item.id === monsterTierId} className={`game-category-chip ${item.id === monsterTierId ? "active" : ""}`} onClick={() => {
              ...
              <div className="game-category-panel">
                <div className="game-frame__minihead"><span>Tempo</span><strong>{tempoProfile.label}</strong></div>
                <div className="game-category-grid" role="radiogroup" aria-label="Tempo profile">
                  {TEMPO_PROFILES.map((item) => (
                    <button key={item.id} type="button" role="radio" aria-checked={item.id === tempoProfileId} className={`game-category-chip ${item.id === tempoProfileId ? "active" : ""}`} onClick={() => {
              ...
              <div className="game-threat-panel">
                ...
                <div className="game-frame__meters" aria-label="Current pressure readout">
                  <div className="game-frame__meter">
                    <span><small>Pressure</small><strong>{computed.pressure} / {computed.budget}</strong></span>
                    <i><b className={computed.pressure > computed.budget ? "is-over" : ""} style={{ width: `${Math.min(pressurePercent, 100)}%` }} /></i>
                  </div>
                  <div className="game-frame__meter">
                    <span><small>Complexity</small><strong>{computed.complexity} / {computed.complexityCap}</strong></span>
                    <i><b className={computed.complexity > computed.complexityCap ? "is-over" : ""} style={{ width: `${Math.min(complexityPercent, 100)}%` }} /></i>
                  </div>
                </div>
              </div>
            </PanelGroup>
        ...
        {viewMode === "composer" && (
          <section className="monster-layout">
            <section className="panel build-canvas monster-canvas" aria-label="The Crucible build canvas">
              <div className="build-head monster-build-head">
                <div>
                  <h2 className="monster-canvas-title">{computed.name}</h2>
                  <div className="monster-canvas-meta-row" aria-label="Current anatomy composer state">
                    <button className="anatomy-frame-btn" type="button" aria-label="Open Monster Frame" title="Open Monster Frame" onClick={() => setFrameOpen(true)}>
                      <SlidersHorizontal aria-hidden="true" />
                    </button>
                    <strong>{composerStarted ? `${selectedSlotCount}/${SLOTS.length} Filled` : "Choose Start"}</strong>
                  </div>
                </div>
                <div className="crucible-head-controls">
                  <div className="brief-actions" aria-label="Build actions">
                    ...
                    <button
                      ...
                      data-tooltip={composerStarted ? "Browse compatible components independently from a specific anatomy slot." : "Choose Pick a Template or Build from Scratch before browsing components."}
                    ...
                    <button
                      ...
                      aria-disabled={!composerStarted}
                      data-tooltip={composerStarted ? "Return to the initial Template / Scratch choice and clear the current build." : "Start a build before using Start Over."}
              ...
              <div className="build-slots monster-slots">
                {SLOTS.map((slot) => {
                  ...
                  const slotFeatures = getSelectedIdsForSlot(selected, slot.id).map((id) => FEATURES.find((feature) => feature.id === id)).filter(Boolean);
                  ...
                  return (
                    ...
                    >
                      <div className="slot-head">
                        <span className="slot-name"><Icon className="slot-icon" aria-hidden="true" /> {slot.label}</span>
                        ...
                        <div className="slot-stack">
                          {slotFeatures.map((feature) => (
                            <article key={feature.id} className="slot-item">
                              ...
                              <p className="slot-item-text"><strong className="slot-item-title">{feature.title}</strong>{normalizeMonsterReferences(feature.summary, computed)}</p>
                            </article>
                          ))}
                        </div>
                      ) : (
          ...
          <section className="panel balance-workbench" aria-label="Monster balance review">
            ...
            <div className="balance-grid balance-grid--simplified">
              <article className="balance-card balance-wide-card balance-recommendations-card">
                <div className="balance-card__head"><span>Fix These First</span><strong>{computed.balanceRecommendations.length || "Clear"}</strong></div>
                <BalanceRecommendationList recommendations={computed.balanceRecommendations} onAction={handleBalanceRecommendationAction} />
              </article>
              <article className="balance-card">
                <div className="balance-card__head"><span>Pressure</span><strong>{computed.pressureProfile.label}</strong></div>
                <Meter label="Pressure" value={computed.pressure} max={computed.budget} percent={pressurePercent} />
                <p className="balance-note">{computed.pressureProfile.sources.join(" · ") || "No pressure sources yet."}</p>
              </article>
              <article className="balance-card">
                <div className="balance-card__head"><span>Complexity</span><strong>{computed.complexityProfile.label}</strong></div>
                <Meter label="Complexity" value={computed.complexity} max={computed.complexityCap} percent={complexityPercent} />
                <p className="balance-note">{computed.complexityProfile.sources.join(" · ") || "No complexity sources yet."}</p>
              </article>
              <article className="balance-card">
                <div className="balance-card__head"><span>Counterplay</span><strong>{computed.counterplayAudit.rating}</strong></div>
                <div className="balance-progress-ring" style={{ "--progress": `${computed.counterplayAudit.score}%` }}><span>{computed.counterplayAudit.score}</span></div>
                <p className="balance-note">{formatCounterplayIssues(computed.counterplayAudit.issues)}</p>
              </article>
              <details className="balance-diagnostics balance-wide-card">
                ...
                <div className="balance-diagnostics__grid">
                  <article className="balance-card">
                    <div className="balance-card__head"><span>Warnings</span><strong>{computed.warnings.length}</strong></div>
                    <WarningList warnings={computed.warnings} />
                  </article>
                  <article className="balance-card">
                    <div className="balance-card__head"><span>Baseline</span><strong>CR {computed.targetCr}</strong></div>
                    <div className="compiled-meta-grid balance-meta-grid">
                      ...
                      <CompiledMeta label="DPR" value={`${computed.effectiveProfile.effectiveDpr3Round} / ${computed.baseline.dpr}`} />
                      <CompiledMeta label="Attack" value={`${modText(computed.attack)} / ${modText(computed.baseline.attackBonus)}`} />
        ...
        {viewMode === "run" && (() => {
          const runSheet = buildRunModeSheet({ name: computed.name, creatureType, category, role, danger, computed, selectedFeatures, traits, actions, bonusActions, reactions, lairActions, deathEffects });
          return (
            <RunModePanel
              sheet={runSheet}
        ...
        {viewMode === "export" && (() => {
          const exportText = buildExportText({ name: computed.name, creatureType, category, role, danger, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, hasLegendaryActions, xp });
          const exportJson = buildExportJson({ name: computed.name, creatureType, category, role, danger, source, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, selectedFeatures, activePreset, xp });
          const statBlock = buildRenderableStatBlock({ name: computed.name, creatureType, category, role, danger, computed, abilityProfile, traits, actions, bonusActions, reactions, legendaryActions, lairActions, deathEffects, selectedFeatures, hasLegendaryActions, xp });
          const exportReadiness = buildExportReadiness({ computed, selected, selectedFeatures, traits, actions, weaknessFeatures: selectedFeatures.filter((feature) => feature.slot === "weakness"), deathEffects, lairActions });
          const exportRunSheet = buildExportRunSheet({ computed, selectedFeatures, traits, actions, bonusActions, reactions, deathEffects, lairActions });
          return (
            <section className="export-workbench" aria-label="Monster export">
              <div className="export-layout">
                ...
                <aside className="panel export-console" aria-label="Export console">
                  ...
                  <ExportReadinessPanel readiness={exportReadiness} onOpenBalance={() => setViewMode("balance")} />

                  <div className="export-action-grid" aria-label="Export actions">
                    <button className={`export-copy-btn ${exportCopyStatus === "text-copied" ? "copied" : exportCopyStatus === "text-failed" ? "failed" : ""}`} type="button" onClick={() => copyExportPayload("text", exportText)}>
                      {exportCopyStatus === "text-copied" ? "Copied Stat Block" : exportCopyStatus === "text-failed" ? "Copy Failed" : "Copy Stat Block"}
                    </button>
                    <button className={`export-copy-btn ${exportCopyStatus === "json-copied" ? "copied" : exportCopyStatus === "json-failed" ? "failed" : ""}`} type="button" onClick={() => copyExportPayload("json", exportJson)}>
                      {exportCopyStatus === "json-copied" ? "Copied JSON" : exportCopyStatus === "json-failed" ? "Copy Failed" : "Copy JSON"}
                    </button>
                  </div>
...
function GuidedFlowPanel({ guidedFlow, onOpenStart, onOpenFrame, onFocusSlot, onOpenBalance, onOpenExport }) {
  ...
  return (
    <section className="guided-flow-panel is-wizard" aria-label="Build flow">
      <div className="guided-flow-next" data-next-kind={guidedFlow.nextAction?.kind || "start"}>
        ...
        <button type="button" onClick={handleNextAction}>{guidedFlow.nextAction?.cta || "Start"}</button>
      </div>

      <nav className="brief-wizard__progress monster-flow-progress" aria-label="Monster build progress" style={{ "--brief-progress": String(guidedFlow.progress) }}>
  ...
  return (
    <div className="monster-start-screen" aria-label="Choose how to begin">
      ...
      <div className="monster-start-grid">
        <button type="button" className="monster-start-card monster-start-card--template" onClick={onPickTemplate}>
          <span className="monster-start-card__icon"><BookOpen aria-hidden="true" /></span>
        ...
        <button type="button" className="monster-start-card monster-start-card--scratch" onClick={onBuildFromScratch}>
          <span className="monster-start-card__icon"><Plus aria-hidden="true" /></span>
          <span className="monster-start-card__body">
...
function MonsterSilhouetteMap({ typeId, selected, activeSlot, guidedSlotId, computed, started, startMode, presetsCount, onPickTemplate, onBuildFromScratch, onOpenFrame, onFocusSlot }) {
  ...
  function renderSlotCard(slotId) {
    const { slot, Icon, card, slotFeatures, feature, filled, active, guided } = getSlotCardData(slotId);
    ...
    return (
      ...
      >
        <span className="monster-silhouette-slot-card__head">
          <span><Icon aria-hidden="true" /> {slot.label}</span>
        ...
        <>
          {startMode === "scratch" && filledCount === 0 && (
            <div className="monster-scratch-hint" aria-label="Scratch build hint">
              ...
              <span>Click Body, Attack Pattern, or Weakness / Tell to install the first graft.</span>
            </div>
          )}
          <div className="monster-silhouette-stage anatomy-stage" data-active-slot={activeSlot} data-start-mode={startMode || "manual"}>
            <div className="anatomy-stage__grid">
              <aside className="anatomy-stage__column anatomy-stage__column--left" aria-label="Left anatomy slots">
                <article className="silhouette-metric-card is-pressure">
                  <Meter label="Pressure" value={computed.pressure} max={computed.budget} percent={clamp((computed.pressure / computed.budget) * 100, 0, 160)} />
                </article>
              ...
              <div className="anatomy-stage__center" aria-label="Interactive monster silhouette">
                <div className="anatomy-stage__silhouette-layer">
                  <svg className="monster-silhouette-connectors" viewBox="0 0 100 100" preserveAspectRatio="none" aria-hidden="true">
                    {SLOTS.map((slot) => {
                      const anchor = profile.anchors[slot.id] || BASE_SILHOUETTE_ANCHORS[slot.id] || { x: 0.5, y: 0.5 };
                  ...
                  >
                    <g className="monster-silhouette-aura">
                      {profile.layers.filter((layer) => layer.id === "aura").map((layer) => <path key={layer.id} d={layer.d} />)}
                    </g>
                    <g className="monster-silhouette-body">
                      {profile.layers.filter((layer) => layer.id !== "aura").map((layer) => <path key={layer.id} className={`silhouette-layer silhouette-layer--${layer.id}`} d={layer.d} />)}
                    </g>
                  </svg>
              ...
              <aside className="anatomy-stage__column anatomy-stage__column--right" aria-label="Right anatomy slots">
                <article className="silhouette-metric-card is-complexity">
                  <Meter label="Complexity" value={computed.complexity} max={computed.complexityCap} percent={clamp((computed.complexity / computed.complexityCap) * 100, 0, 160)} />
                </article>
                <div className="anatomy-stage__slot-stack">
...
function TemplatePickerModal({ open, presets, activePresetId, onApply, onClose }) {
  ...
  return (
    <div className="template-picker-modal" role="dialog" aria-modal="true" aria-label="Pick a monster template">
      <button className="template-picker-modal__scrim" type="button" aria-label="Close Template Picker" onClick={onClose} />
      <aside className="panel template-picker-modal__panel" aria-label="Monster templates">
        <div className="template-picker-modal__head">
          ...
          <button className="icon-btn" type="button" aria-label="Close Template Picker" onClick={onClose}>
            <X aria-hidden="true" />
          </button>
        </div>
          ...
          {presets.map((preset) => {
            ...
            return (
              <article key={preset.id} className={`template-choice-card ${active ? "active" : ""}`}>
                <button type="button" className="template-choice-card__button" onClick={() => onApply(preset)}>                  <span className="template-choice-card__title-row">
...
function ComponentNavigatorModal({
  ...
  const modalTitle = mode === "global"
    ? navigatorSlotFilter === "all" ? "Global Component Navigator" : `${filteredSlotData?.label || "Filtered"} Components`
  ...
  return (
    <div className="component-navigator-modal" data-navigator-mode={mode} role="dialog" aria-modal="true" aria-label={modalTitle}>
      <button className="component-navigator-modal__scrim" type="button" aria-label="Close Component Navigator" onClick={onClose} />
      <aside className="panel navigator monster-navigator component-navigator-modal__panel" aria-label="Component Navigator">
        <div className="component-navigator-modal__head">
          <div>
            <h2>{modalTitle}</h2>
          </div>
          <button className="icon-btn" type="button" aria-label="Close Component Navigator" onClick={onClose}>
            <X aria-hidden="true" />
          </button>
        </div>
        ...
        <div className="navigator-tools monster-navigator-tools">
          <div className="navigator-search-row">
            ...
            <button
              ...
              data-active-count={navigatorSearch.trim() || sourceId !== "decomposition" || (mode === "global" && navigatorSlotFilter !== "all") ? 1 : 0}
              onClick={() => setNavigatorFiltersOpen((current) => !current)}
            >
              <SlidersHorizontal aria-hidden="true" />
            </button>
            <div className="navigator-count" aria-label="Visible component count">{visibleFeatures.length}</div>
          </div>
          ...
          {navigatorFiltersOpen && (
            <div className="tag-filter-row monster-source-grid-open" aria-label="Filter components">
              <div className="tag-filter-row__head">
                ...
                <button className="tag-clear-btn" type="button" onClick={() => {
                  setNavigatorSearch("");
              ...
              <div className="navigator-filter-panel">
                <section className="navigator-filter-section">
                  ...
                  <div className="filter-chip-grid source-filter">
                    {SOURCES.map((item) => (
                      <button key={item.id} type="button" className={`navigator-filter-chip ${item.id === sourceId ? "active" : ""}`} aria-pressed={item.id === sourceId} onClick={() => {
                        setSourceId(item.id);
                        setActivePresetId("");
                      }}>
                        {item.label}
        ...
        {mode === "global" && (
          <div className="source-modal__tools monster-slot-tabs component-navigator-modal__slot-tabs">
            <button type="button" className={`navigator-filter-chip ${navigatorSlotFilter === "all" ? "active" : ""}`} onClick={() => setNavigatorSlotFilter("all")}>All</button>
            {SLOTS.map((slot) => (
              <button key={slot.id} type="button" className={`navigator-filter-chip ${slot.id === navigatorSlotFilter ? "active" : ""}`} onClick={() => {
        ...
        <div className="component-list monster-component-list component-navigator-modal__list">
          {visibleFeatures.length === 0 ? (
            ...
            visibleFeatures.map((feature) => {
              ...
              const slotFull = featureSlotCap > 1 && featureSlotIds.length >= featureSlotCap && !selectedInSlot;
              const compatibility = getCompatibilityStatus(feature, selectedFeatures, typeId, category);
...
function GraftInspector({ slot, features, alternatives, source, computed, onClear, onRemoveFeature }) {
  const Icon = slot.icon;
  const installed = features.length > 0;

  return (
    <details className={`graft-inspector ${installed ? "has-feature" : "is-empty"}`} aria-label="Selected graft inspector">
      <summary className="graft-inspector__head">
        <div>
          <h3><Icon aria-hidden="true" /> {slot.label}</h3>
        </div>
      ...
      {installed ? (
        <div className="graft-inspector__content">
                ...
                <article key={feature.id} className="graft-inspector__item">
                  <div className="graft-inspector__main">
                    <div className="graft-inspector__title-row">
                      <h4>{feature.title}</h4>
                      <button type="button" aria-label={`Remove ${feature.title}`} onClick={() => onRemoveFeature(feature.id)}>
                        <X aria-hidden="true" />
                      </button>
                    </div>
          ...
          <div className="graft-inspector__footer">
            <span>{alternatives} alternative{alternatives === 1 ? "" : "s"}</span>
        ...
        <div className="graft-inspector__empty">
          <p>{slot.hint}</p>
          <span>{alternatives} compatible graft{alternatives === 1 ? "" : "s"}</span>
        </div>
      )}
    </details>
  );
...
function SmartSlotPicks({ slotId, picks, selected, selectedFeatures, typeId, category, advancedMode, slotCaps, computed, onAdd }) {
  const slot = SLOTS.find((item) => item.id === slotId) || SLOTS[0];
    ...
    <section className="smart-slot-picks" aria-label={`Best picks for ${slot.label}`}>
      ...
      <div className="smart-slot-picks__grid">
        {picks.map((pick) => {
          ...
          const slotFull = featureSlotCap > 1 && featureSlotIds.length >= featureSlotCap && !selectedInSlot;
          const compatibility = getCompatibilityStatus(feature, selectedFeatures, typeId, category);
          const impact = buildFeatureImpactPreview({ feature, selected, selectedFeatures, typeId, category, computed });
          const disabled = selectedInSlot || slotFull || ["missing", "incompatible"].includes(compatibility.kind);
          return (
...
function FeatureCard({ feature, selected, slotFull, compatibility, decisionProfile, selectedBuild, selectedFeatures, typeId, category, computed, onAdd, onDragStart, onDragEnd }) {
  ...
  const impact = buildFeatureImpactPreview({ feature, selected: selectedBuild || {}, selectedFeatures: selectedFeatures || [], typeId, category, computed });
  return (
    <motion.article
      layout
    ...
    >
      <button className="component-toggle-btn" type="button" onClick={onAdd} aria-label={selected ? `${feature.title} already installed` : slotFull ? `${titleCase(feature.slot)} slot is full` : `Add ${feature.title}`} disabled={selected || slotFull}>
      ...
      <div className="card-top">
        ...
        {hasCompatibilityBadge && <span className={`compatibility-badge ${compatibility.kind}`}>{compatibility.label}</span>}
      </div>
      ...
      {slotFull && <p className="compatibility-note">This slot is full. Raise its cap or remove a graft first.</p>}
      <details className="component-details">
        <summary>Details</summary>
        <div className="meta-list" aria-label="Component metadata">
          <div className="meta-row"><span className="meta-label">Source</span><span className="meta-values"><span className="meta-value source-chip">{source?.label}</span></span></div>
          <div className="meta-row"><span className="meta-label">Slot</span><span className="meta-values"><span className="meta-value strong-chip">{titleCase(feature.slot)}</span><span className="meta-value">{getSectionLabel(getFeatureSection(feature))}</span></span></div>
          {mechanicProfile.mechanicTags.length > 0 && <div className="meta-row"><span className="meta-label">Tags</span><span className="meta-values">{mechanicProfile.mechanicTags.slice(0, 5).map((tag) => <span key={tag} className="meta-value">{formatToken(tag)}</span>)}</span></div>}
          {rules.grants.length > 0 && <div className="meta-row"><span className="meta-label">Grants</span><span className="meta-values">{rules.grants.map((token) => <span key={token} className="meta-value">{formatToken(token)}</span>)}</span></div>}
          {(rules.requires.length > 0 || rules.softRequires.length > 0 || rules.incompatibleWith.length > 0) && (
            <div className="meta-row"><span className="meta-label">Locks</span><span className="meta-values">
              {rules.requires.map((token) => <span key={`requires-${token}`} className="meta-value strong-chip">Requires {formatToken(token)}</span>)}
              {rules.softRequires.map((token) => <span key={`soft-${token}`} className="meta-value">Wants {formatToken(token)}</span>)}
              {rules.incompatibleWith.map((token) => <span key={`blocks-${token}`} className="meta-value danger-chip">Blocks {formatToken(token)}</span>)}
            </span></div>
          )}
        </div>
      </details>
  ...
  return (
    <div className="monster-meter">
      <div className="monster-meter__head">
        <span>{label}</span>
        <strong className={over ? "is-over" : ""}>{value} / {max}</strong>
      </div>
  ...
  if (!warnings.length) {
    return (
      <div className="monster-warning monster-warning--ok">
        <Shield aria-hidden="true" />
        <span>The monster has a weakness/tell, stays inside the pressure budget, and should be playable for the selected use.</span>
      </div>
    );
  }
...
function RunModePanel({ sheet, recommendations, onAction, onOpenComposer, onOpenBalance, onOpenExport }) {
  return (
    <section className="run-mode-workbench" aria-label="Run mode">
      <div className="run-mode-hero">
        ...
        <div className="run-mode-actions" aria-label="Run mode actions">
          <button type="button" onClick={onOpenComposer}>Composer</button>
          <button type="button" onClick={onOpenBalance}>Balance</button>
      ...
      <div className="run-mode-grid">
        ...
        <section className="run-panel">
          ...
          <BalanceRecommendationList recommendations={recommendations.slice(0, 3)} onAction={onAction} />
        </section>
      </div>
    </section>
  );
  ...
  return (
    <section className="run-panel run-panel--wide">
      ...
      {items.length ? (
        ...
        <p className="run-empty">No reactions, lair actions, recharge hooks, or death triggers installed.</p>
      )}
    </section>
  );
}
    ...
    return (
      <div className="balance-recommendation balance-recommendation--ok">
        ...
        <div>
          ...
          <p>The monster is within the current pressure and complexity targets, and the counterplay audit is playable.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="balance-recommendation-list">
      {recommendations.map((recommendation) => (
        <article key={recommendation.id} className={`balance-recommendation is-${recommendation.severity}`}>
          <AlertTriangle aria-hidden="true" />
            ...
            {recommendation.actions?.length > 0 && (
              <div className="balance-recommendation__actions">
                {recommendation.actions.map((action) => (
                  <button key={`${recommendation.id}-${action.label}`} type="button" onClick={() => onAction?.(action)}>
                    {action.label}
                  </button>
                ))}
              </div>
...
function RenderedStatBlock({ statBlock }) {
  ...
  return (
    <article className="cruor-stat-block rendered-stat-block" aria-label={`${statBlock.name} rendered stat block`}>
      ...
      <section className="cruor-stat-block__abilities" aria-label="Ability scores">
        <div className="table-overflow-wrapper">
          <table className="cruor-ability-table">
            <thead>
              <tr>
                {statBlock.abilities.map((ability) => <th key={ability.key}>{ability.label}</th>)}
              </tr>
            </thead>
            <tbody>
              <tr>
                {statBlock.abilities.map((ability) => <td key={`${ability.key}-score`}>{ability.score}</td>)}
              </tr>
              <tr>
                {statBlock.abilities.map((ability) => <td key={`${ability.key}-mod`}>{modText(ability.mod)}</td>)}
              </tr>
              <tr>
                {statBlock.abilities.map((ability) => <td key={`${ability.key}-save`}>Save {modText(ability.save)}</td>)}
              </tr>
            </tbody>
          </table>
        </div>
      ...
      {visibleSections.map((section) => (
        <RenderedStatBlockSection key={section.id} title={section.title} items={section.items} highlight={section.highlight} />
      ))}

      <details className="cruor-stat-block__designer-notes">
        <summary>Designer Notes</summary>
        <div>
          {statBlock.designerNotes.map((note) => <p key={note}>{note}</p>)}
        </div>
      </details>
    </article>
  );
...
function ExportReadinessPanel({ readiness, onOpenBalance }) {
  return (
    <section className={`export-readiness-card ${readiness.ready ? "is-ready" : readiness.blockers.length ? "is-blocked" : "needs-review"}`} aria-label="Export readiness">
      ...
      <div className="export-readiness-meter" aria-hidden="true"><span style={{ width: `${readiness.percent}%` }} /></div>
      <div className="export-check-grid">
        {readiness.checks.map((check) => (
          <article key={check.id} className={`export-check ${check.ready ? "is-ready" : check.severity === "required" ? "is-blocked" : "needs-review"}`}>
